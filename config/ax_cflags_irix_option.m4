...
dnl variant.
dnl
dnl This descendent modified by Shannon Brown  to use AC_LANG_CPLUSPLUS
dnl instead of AC_LANG_CXX, as well as regexp([],[]) instead of
dnl m4_regexp([],[]).
dnl
dnl @category C
...
AC_DEFUN([AX_CFLAGS_IRIX_OPTION],[ifelse(regexp([$2],[-]),-1,
[AX_CFLAGS_IRIX_OPTION_NEW($@)],[AX_CFLAGS_IRIX_OPTION_OLD($@)])])

AC_DEFUN([AX_CXXFLAGS_IRIX_OPTION],[ifelse(regexp([$2],[-]),-1,
