...
-  Gradient-based optimizers: CONMIN, DOT, NLPQL, NPSOL, and OPT++ can
   ...
   techniques :cite:p:`Byr88` to obtain better parallel load
...
current research direction :cite:p:`Bar01b`.
...
issues, refer to :cite:p:`Eld00`. In many cases, *the user may
...
selection of :math:`\tau_i` is discussed in :cite:p:`Eld00`.
