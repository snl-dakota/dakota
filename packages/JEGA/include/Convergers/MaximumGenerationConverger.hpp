...
================================================================================
    ...
    CONTENTS:
        ...
        Definition of class MaximumGenerationConverger.
...
*/
/** \file
 * \brief Contains the definition of the MaximumGenerationConverger class.
 */
...
================================================================================
*/
#ifndef JEGA_ALGORITHMS_MAXIMUMGENERATIONCONVERGER_HPP
#define JEGA_ALGORITHMS_MAXIMUMGENERATIONCONVERGER_HPP
...
================================================================================
*/
class MaximumGenerationConverger;
...
/// Indicates convergence by exceeding maximum generations.
/**
 * This converger checks the current generation of the GeneticAlgorithm
 * and returns true if that value is greater than the specified
    ...
    public GeneticAlgorithmConverger
{
    ...
    */
    public:
        ...
        /**
         * \return The string "max_generations".
         */
        static
        const std::string&
        Name(
         ...
         * \return A new, default instance of a MaximumGenerationConverger.
         */
        static
    ...
    */
    public:
        ...
        /**
         * This method checks to see if the maximum number of generations
    ...
    */
    public:
        ...
        /**
         * \brief Constructs a MaximumGenerationConverger for use by \a
         *         algorithm.
         *
         * \param algorithm The GA for which the new converger is to be used.
         */
        MaximumGenerationConverger(
            GeneticAlgorithm& algorithm
            );

        /// Copy constructs a MaximumGenerationConverger.
        /**
        ...
        /**
         * \brief Copy constructs a MaximumGenerationConverger for use by
         *        \a algorithm.
         *
         * \param copy The converger from which properties are to be duplicated
         *             into this.
...
================================================================================
*/
#include "./inline/MaximumGenerationConverger.hpp.inl"
...
================================================================================
*/
#endif // JEGA_ALGORITHMS_MAXIMUMGENERATIONCONVERGER_HPP
