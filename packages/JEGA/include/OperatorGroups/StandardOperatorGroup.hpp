...
================================================================================
    ...
    CONTENTS:
        ...
        Definition of class StandardOperatorGroup.
...
*/
/** \file
 * \brief Contains the definition of the StandardOperatorGroup class.
 */
...
================================================================================
*/
#ifndef JEGA_ALGORITHMS_STANDARDOPERATORGROUP_HPP
#define JEGA_ALGORITHMS_STANDARDOPERATORGROUP_HPP
...
/// This group contains operators that can be used by any GeneticAlgorithm.
/**
 * This group is meant to contain the most benign operators available.
 * Those are the operators that don't care what type of GA they are being
 * used on and don't care what other operators are being used.
 *
 * As a result of this, it is required that the operators in this group not
 * do anything to the Designs or the algorithm that would cause problems
 * with other operators (such as temporarily modifying design variable values
 * for the sake of some encoding).  If you are creating operators that must be
 * used in conjunction with one another, make a different group for them.
 */
class StandardOperatorGroup :
    public GeneticAlgorithmOperatorGroup
{
    ...
    */
    public:
        ...
        /**
         * \return The string "Standard Operator Group".
         */
        static
        const std::string&
        Name(
...
================================================================================
*/
#include "./inline/StandardOperatorGroup.hpp.inl"
...
================================================================================
*/
#endif // JEGA_ALGORITHMS_STANDARDOPERATORGROUP_HPP
