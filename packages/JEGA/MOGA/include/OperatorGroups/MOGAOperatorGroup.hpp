...
================================================================================
    ...
    CONTENTS:
        ...
        Definition of class MOGAOperatorGroup.
...
*/
/** \file
 * \brief Contains the definition of the MOGAOperatorGroup class.
 */
...
================================================================================
*/
#ifndef JEGA_ALGORITHMS_MOGAOPERATORGROUP_HPP
#define JEGA_ALGORITHMS_MOGAOPERATORGROUP_HPP
...
/// This group contains regular operators that can be used with a MOGA
/**
 * This group is meant to contain the most benign operators that can be
 * used with a MOGA.  If you create a set of specialized operators that must
    ...
    public GeneticAlgorithmOperatorGroup
{
    ...
    */
    public:
        ...
        /**
         * \return The string "Standard MOGA Operator Group".
         */
        static
        const std::string&
        Name(
    ...
    */
    ...
    private:
        ...
        /// Constructs a MOGAOperatorGroup
        /**
...
================================================================================
*/
#include "./inline/MOGAOperatorGroup.hpp.inl"
...
================================================================================
*/
#endif // JEGA_ALGORITHMS_MOGAOPERATORGROUP_HPP
