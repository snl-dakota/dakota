...
================================================================================
    ...
    CONTENTS:
        ...
        Definition of class FavorFeasibleOperatorGroup.
...
*/
/** \file
 * \brief Contains the definition of the FavorFeasibleOperatorGroup class.
 */
...
================================================================================
*/
#ifndef JEGA_ALGORITHMS_FAVORFEASIBLEOPERATORGROUP_HPP
#define JEGA_ALGORITHMS_FAVORFEASIBLEOPERATORGROUP_HPP
...
================================================================================
*/
class FavorFeasibleOperatorGroup;
...
/**
 * \brief This group contains the subset of operators that can be used in a SOGA
 *        using the FavorFeasibleSelector.
 *
 * This group is basically the same as the SOGA operator group except that it
 * only contains the favor feasible selector and weighted sum only fitness
 * assessor.
 */
class FavorFeasibleOperatorGroup :
    public GeneticAlgorithmOperatorGroup
{
    ...
    */
    public:
        ...
        /**
         * \return The string "Favor Feasible Operator Group".
         */
        static
        const std::string&
        Name(
...
================================================================================
*/
#include "./inline/FavorFeasibleOperatorGroup.hpp.inl"
...
================================================================================
*/
#endif // JEGA_ALGORITHMS_FAVORFEASIBLEOPERATORGROUP_HPP
