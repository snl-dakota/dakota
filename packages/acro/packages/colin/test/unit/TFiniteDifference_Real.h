...
namespace colin {
namespace unittest { class FiniteDifferenceApplication_RealDomain; }

class colin::unittest::FiniteDifferenceApplication_RealDomain   \
...
public:
   FiniteDifferenceApplication_RealDomain()
      : x(3)
   {
      x[0] = 1;
      x[1] = 2;
...
public:
   void test_construct()
   {
      ...
      colin::FiniteDifferenceApplication<NLP1_problem> app1;
      TS_ASSERT_EQUALS(app1.domain_size, 0);
      
      app1.reformulate_application(base);
      TS_ASSERT_EQUALS(app1.domain_size, 3);

      colin::FiniteDifferenceApplication<NLP1_problem> app2(base);
   ...
   {
      TestApplications::singleObj_denseCon<NLP0_problem> base;
      colin::FiniteDifferenceApplication<NLP1_problem> app(base);
   ...
   void test_mo_g()
   {
      ...
      colin::FiniteDifferenceApplication<MO_NLP1_problem> app(base);
   ...
   void test_cg()
   {
      TestApplications::singleObj_denseCon<SNLP0_problem> base;
      colin::FiniteDifferenceApplication<SNLP1_problem> app(base);
