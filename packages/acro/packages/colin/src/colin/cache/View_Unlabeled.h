...
/**
 * \file cache/View_Unlabeled.h
 *
 * Defines the colin::cache::View_Unlabeled class.
 */

#ifndef colin_cache_View_Unlabeled_h
#define colin_cache_View_Unlabeled_h
...
class View_Unlabeled : public View_CommonBase
{
public:
   View_Unlabeled();
...
#endif // defined colin_cache_View_Unlabeled_h
