...
\begin{figure}[tpb]
\begin{center}
\epsfig{file=layers.eps,scale=0.8}
\vspace{-0.2in}
\end{center}
...
\subsection{Special Search Features}
...
For example, our binary knapsack solver defines a class {\tt
...
\begin{figure}[tbp]
\begin{center}
\epsfig{file=globalsub.eps,scale=0.8}
\vspace{-0.2in}
\end{center}
...
\begin{figure}[tbp]
\begin{center}
\epsfig{file=states.eps,scale=0.7}
\vspace{-0.2in}
\end{center}
...
\begin{figure}[tbp]
\begin{center}
\epsfig{file=poolandhandler.eps,scale=0.7}
\vspace{-0.2in}
\end{center}
...
\begin{figure}[tb]
\begin{center}
\epsfig{file=parinherit.eps,scale=0.7}
\vspace{-0.2in}
\end{center}
...
Three run-time parameters, all defined in \texttt{parallelPebblBase},
...
\subsection{Work distribution between clusters}
...
To help you improve ramp-up performance, PEBBL implements
...
\begin{figure}[tbp]
\begin{center}
\epsfig{file=threads.eps,scale=0.8}
\vspace{-0.2in}
\end{center}
