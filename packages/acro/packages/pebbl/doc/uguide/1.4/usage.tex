...
code in Figure~\ref{fig:parreposscan} scans every solution in the
repository through processor $0$, which prints their objective values:
...
\vspace{1ex}
\begin{codeblock}
int nSols = \emph{instance}.startRepository scan; \\
