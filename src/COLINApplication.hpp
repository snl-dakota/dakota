...
// virtual public colin::Application<colin::MO_NLP2_problem>
{
 public:
  ...
  utilib::Any spawn_evaluation_impl(
  ...
  void perform_evaluation_impl(
      const utilib::Any &domain,
      const colin::AppRequest::request_map_t &requests, utilib::seed_t &seed,
      colin::AppResponse::response_map_t &colin_responses) override;

  /// Collect a completed evaluation from DAKOTA.
  utilib::Any collect_evaluation_impl(
