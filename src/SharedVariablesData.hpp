...
class SharedVariablesDataRep {
 ...
 private:
  ...
  void uncertain_counts(size_t& num_cuv, size_t& num_duiv, size_t& num_dusv,
                        size_t& num_durv) const;
  /// compute state variables sums from variablesCompsTotals
  void state_counts(size_t& num_csv, size_t& num_dsiv, size_t& num_dssv,
  ...
  size_t cv_index_to_all_index(size_t cv_index, bool cdv, bool cauv, bool ceuv,
                               bool csv) const;
  ...
  size_t div_index_to_all_index(size_t div_index, bool ddv, bool dauv,
                                bool deuv, bool dsv) const;
  /// convert index within active discrete string variables (as
  /// identified by bools) to index within aggregated variables (all
  /// continous, discrete {int,string,real})
  size_t dsv_index_to_all_index(size_t dsv_index, bool ddv, bool dauv,
                                bool deuv, bool dsv) const;
  /// convert index within active discrete real variables (as
  /// identified by bools) to index within aggregated variables (all
  /// continous, discrete {int,string,real})
  size_t drv_index_to_all_index(size_t drv_index, bool ddv, bool dauv,
                                bool deuv, bool dsv) const;
...
inline SharedVariablesDataRep::SharedVariablesDataRep()
    : cvStart(0),
      ...
      numIDIV(0),
      numIDSV(0),
      numIDRV(0) { /* empty ctor */ }

inline SharedVariablesDataRep::~SharedVariablesDataRep() { /* empty dtor */ }
...
inline void SharedVariablesDataRep::all_counts(size_t& num_acv,
                                               size_t& num_adiv,
                                               size_t& num_adsv,
                                               size_t& num_adrv) const {
...
inline void SharedVariablesDataRep::relax_counts(size_t& num_cv,
                                                 size_t& num_div,
                                                 size_t& num_drv,
                                                 size_t offset_di,
                                                 size_t offset_dr) const {
  size_t i, num_relax_int = 0, num_relax_real = 0, end_di = num_div + offset_di,
            end_dr = num_drv + offset_dr;
  for (i = offset_di; i < end_di; ++i)
    if (allRelaxedDiscreteInt[i]) ++num_relax_int;
  for (i = offset_dr; i < end_dr; ++i)
    if (allRelaxedDiscreteReal[i]) ++num_relax_real;
  num_cv += num_relax_int + num_relax_real;
  num_div -= num_relax_int;
  num_drv -= num_relax_real;
}

inline void SharedVariablesDataRep::design_counts(size_t& num_cdv,
                                                  size_t& num_ddiv,
                                                  size_t& num_ddsv,
                                                  size_t& num_ddrv) const {
...
inline void SharedVariablesDataRep::aleatory_uncertain_counts(
    size_t& num_cauv, size_t& num_dauiv, size_t& num_dausv,
...
inline void SharedVariablesDataRep::epistemic_uncertain_counts(
    size_t& num_ceuv, size_t& num_deuiv, size_t& num_deusv,
...
inline void SharedVariablesDataRep::uncertain_counts(size_t& num_cuv,
                                                     size_t& num_duiv,
                                                     size_t& num_dusv,
                                                     size_t& num_durv) const {
  num_cuv = variablesCompsTotals[TOTAL_CAUV] + variablesCompsTotals[TOTAL_CEUV];
  num_duiv =
      variablesCompsTotals[TOTAL_DAUIV] + variablesCompsTotals[TOTAL_DEUIV];
  num_dusv =
      variablesCompsTotals[TOTAL_DAUSV] + variablesCompsTotals[TOTAL_DEUSV];
  num_durv =
      variablesCompsTotals[TOTAL_DAURV] + variablesCompsTotals[TOTAL_DEURV];
...
inline void SharedVariablesDataRep::state_counts(size_t& num_csv,
                                                 size_t& num_dsiv,
                                                 size_t& num_dssv,
                                                 size_t& num_dsrv) const {
...
inline void SharedVariablesDataRep::view_subsets(short view, bool& cdv,
                                                 bool& ddv, bool& cauv,
                                                 bool& dauv, bool& ceuv,
                                                 bool& deuv, bool& csv,
                                                 bool& dsv) const {
  ...
  switch (view) {
    case RELAXED_ALL:
    case MIXED_ALL:
      cdv = ddv = cauv = dauv = ceuv = deuv = csv = dsv = true;
      break;
    case RELAXED_UNCERTAIN:
    case MIXED_UNCERTAIN:
      cdv = ddv = csv = dsv = false;
      cauv = dauv = ceuv = deuv = true;
      break;
    case RELAXED_ALEATORY_UNCERTAIN:
    case MIXED_ALEATORY_UNCERTAIN:
      cdv = ddv = ceuv = deuv = csv = dsv = false;
      cauv = dauv = true;
      break;
    case RELAXED_EPISTEMIC_UNCERTAIN:
    case MIXED_EPISTEMIC_UNCERTAIN:
      cdv = ddv = cauv = dauv = csv = dsv = false;
      ceuv = deuv = true;
      break;
    case RELAXED_DESIGN:
    case MIXED_DESIGN:
      cauv = dauv = ceuv = deuv = csv = dsv = false;
      cdv = ddv = true;
      break;
    case RELAXED_STATE:
    case MIXED_STATE:
      cdv = ddv = cauv = dauv = ceuv = deuv = false;
      csv = dsv = true;
      break;
    default:  // EMPTY_VIEW (e.g., inactive view not yet defined)
      cdv = ddv = cauv = dauv = ceuv = deuv = csv = dsv = false;
      break;
  }
}
...
class SharedVariablesData {
 public:
  ...
  /// define active variable subsets based on active view
  void active_subsets(bool& cdv, bool& ddv, bool& cauv, bool& dauv, bool& ceuv,
  ...
  StringMultiArrayView all_continuous_labels(size_t start,
  ...
  StringMultiArrayView all_discrete_int_labels(size_t start,
                                               size_t num_items) const;
  ...
  StringMultiArrayView all_discrete_string_labels(size_t start,
                                                  size_t num_items) const;
  ...
  StringMultiArrayView all_discrete_real_labels(size_t start,
                                                size_t num_items) const;
  ...
  UShortMultiArrayConstView all_continuous_types(size_t start,
                                                 size_t num_items) const;
  /// set num_items continuous types beginning at index start
  void all_continuous_types(UShortMultiArrayConstView cv_types, size_t start,
                            size_t num_items);
  ...
  UShortMultiArrayConstView all_discrete_int_types(size_t start,
                                                   size_t num_items) const;
  /// set num_items discrete integer types beginning at index start
  void all_discrete_int_types(UShortMultiArrayConstView div_types, size_t start,
                              size_t num_items);
  ...
  UShortMultiArrayConstView all_discrete_string_types(size_t start,
                                                      size_t num_items) const;
  ...
  UShortMultiArrayConstView all_discrete_real_types(size_t start,
                                                    size_t num_items) const;
  ...
  SizetMultiArrayConstView all_continuous_ids(size_t start,
                                              size_t num_items) const;
  /// set num_items continuous ids beginning at index start
  void all_continuous_ids(SizetMultiArrayConstView cv_ids, size_t start,
                          size_t num_items);
  /// set num_items continuous ids beginning at index start
  void all_continuous_id(size_t id, size_t index);

  /// get num_items discrete int ids beginning at index start
  SizetMultiArrayConstView all_discrete_int_ids(size_t start,
                                                size_t num_items) const;
  /// get num_items discrete string ids beginning at index start
  SizetMultiArrayConstView all_discrete_string_ids(size_t start,
                                                   size_t num_items) const;
  /// get num_items discrete real ids beginning at index start
  SizetMultiArrayConstView all_discrete_real_ids(size_t start,
                                                 size_t num_items) const;
  ...
  size_t idrv_start()
      const;  ///< get start index of inactive discrete real vars
  ...
  void drv_start(
      size_t drvs);       ///< set start index of active discrete real vars
  ...
  void idiv_start(
      size_t idivs);        ///< set start index of inactive discr int vars
  void idsv(size_t nidsv);  ///< set number of inactive discr string vars
  void idsv_start(
      size_t idsvs);        ///< set start index of inact discr string vars
...
inline SharedVariablesData::SharedVariablesData() { /* empty ctor */ }

inline SharedVariablesData::SharedVariablesData(const ProblemDescDB& problem_db,
                                                const ShortShortPair& view)
    : svdRep(new SharedVariablesDataRep(problem_db, view)) { /* empty ctor */ }
...
inline SharedVariablesData::SharedVariablesData(
    ...
    : svdRep(new SharedVariablesDataRep(view, vars_comps, all_relax_di,
                                        all_relax_dr)) { /* empty ctor */ }

inline SharedVariablesData::SharedVariablesData(
    const ShortShortPair& view, const SizetArray& vars_comps_totals,
    const BitArray& all_relax_di, const BitArray& all_relax_dr)
...
inline SharedVariablesData& SharedVariablesData::operator=(
    const SharedVariablesData& svd) {
...
inline SharedVariablesData::~SharedVariablesData() { /* empty dtor in case we
                                                        add virtual functions */
}

inline void SharedVariablesData::all_counts(size_t& num_acv, size_t& num_adiv,
                                            size_t& num_adsv,
                                            size_t& num_adrv) const {
  svdRep->all_counts(num_acv, num_adiv, num_adsv, num_adrv);
}

inline void SharedVariablesData::design_counts(size_t& num_cdv,
                                               size_t& num_ddiv,
                                               size_t& num_ddsv,
                                               size_t& num_ddrv) const {
...
inline void SharedVariablesData::aleatory_uncertain_counts(
    size_t& num_cauv, size_t& num_dauiv, size_t& num_dausv,
    size_t& num_daurv) const {
  svdRep->aleatory_uncertain_counts(num_cauv, num_dauiv, num_dausv, num_daurv);
}

inline void SharedVariablesData::epistemic_uncertain_counts(
    size_t& num_ceuv, size_t& num_deuiv, size_t& num_deusv,
    size_t& num_deurv) const {
  svdRep->epistemic_uncertain_counts(num_ceuv, num_deuiv, num_deusv, num_deurv);
}

inline void SharedVariablesData::uncertain_counts(size_t& num_cuv,
                                                  size_t& num_duiv,
                                                  size_t& num_dusv,
                                                  size_t& num_durv) const {
...
inline void SharedVariablesData::state_counts(size_t& num_csv, size_t& num_dsiv,
                                              size_t& num_dssv,
                                              size_t& num_dsrv) const {
  svdRep->state_counts(num_csv, num_dsiv, num_dssv, num_dsrv);
}

inline void SharedVariablesData::active_subsets(bool& cdv, bool& ddv,
                                                bool& cauv, bool& dauv,
                                                bool& ceuv, bool& deuv,
                                                bool& csv, bool& dsv) const {
  svdRep->view_subsets(svdRep->variablesView.first, cdv, ddv, cauv, dauv, ceuv,
                       deuv, csv, dsv);
}

inline void SharedVariablesData::inactive_subsets(bool& cdv, bool& ddv,
                                                  bool& cauv, bool& dauv,
                                                  bool& ceuv, bool& deuv,
                                                  bool& csv, bool& dsv) const {
  svdRep->view_subsets(svdRep->variablesView.second, cdv, ddv, cauv, dauv, ceuv,
                       deuv, csv, dsv);
}

inline void SharedVariablesData::complement_subsets(bool& cdv, bool& ddv,
                                                    bool& cauv, bool& dauv,
                                                    bool& ceuv, bool& deuv,
                                                    bool& csv,
                                                    bool& dsv) const {
  bool active_cdv, active_ddv, active_cauv, active_dauv, active_ceuv,
      active_deuv, active_csv, active_dsv;
...
inline size_t SharedVariablesData::cv_index_to_all_index(
...
inline size_t SharedVariablesData::icv_index_to_all_index(
    size_t icv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  inactive_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->cv_index_to_all_index(icv_index, cdv, cauv, ceuv, csv);
}

inline size_t SharedVariablesData::ccv_index_to_all_index(
    size_t ccv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  complement_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->cv_index_to_all_index(ccv_index, cdv, cauv, ceuv, csv);
}

inline size_t SharedVariablesData::acv_index_to_all_index(
    size_t acv_index) const {
  return svdRep->cv_index_to_all_index(acv_index, true, true, true, true);
}

inline size_t SharedVariablesData::div_index_to_all_index(
    size_t div_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  active_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->div_index_to_all_index(div_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::idiv_index_to_all_index(
    size_t idiv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  inactive_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->div_index_to_all_index(idiv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::cdiv_index_to_all_index(
    size_t cdiv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  complement_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->div_index_to_all_index(cdiv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::adiv_index_to_all_index(
    size_t adiv_index) const {
  return svdRep->div_index_to_all_index(adiv_index, true, true, true, true);
}

inline size_t SharedVariablesData::dsv_index_to_all_index(
    size_t dsv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  active_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->dsv_index_to_all_index(dsv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::idsv_index_to_all_index(
    size_t idsv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  inactive_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->dsv_index_to_all_index(idsv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::cdsv_index_to_all_index(
    size_t cdsv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  complement_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->dsv_index_to_all_index(cdsv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::adsv_index_to_all_index(
    size_t adsv_index) const {
  return svdRep->dsv_index_to_all_index(adsv_index, true, true, true, true);
}

inline size_t SharedVariablesData::drv_index_to_all_index(
    size_t drv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  active_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->drv_index_to_all_index(drv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::idrv_index_to_all_index(
    size_t idrv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  inactive_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->drv_index_to_all_index(idrv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::cdrv_index_to_all_index(
    size_t cdrv_index) const {
  bool cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv;
  complement_subsets(cdv, ddv, cauv, dauv, ceuv, deuv, csv, dsv);
  return svdRep->drv_index_to_all_index(cdrv_index, ddv, dauv, deuv, dsv);
}

inline size_t SharedVariablesData::adrv_index_to_all_index(
    size_t adrv_index) const {
...
inline StringMultiArrayView SharedVariablesData::all_continuous_labels(
    size_t start, size_t num_items) const {
  return svdRep->allContinuousLabels[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_continuous_labels(
    StringMultiArrayConstView cv_labels, size_t start, size_t num_items) {
  svdRep->allContinuousLabels[boost::indices[idx_range(
      start, start + num_items)]] = cv_labels;
}

inline void SharedVariablesData::all_continuous_label(const String& cv_label,
                                                      size_t index) {
  svdRep->allContinuousLabels[index] = cv_label;
}

inline StringMultiArrayView SharedVariablesData::all_discrete_int_labels(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteIntLabels[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_int_labels(
    StringMultiArrayConstView div_labels, size_t start, size_t num_items) {
  svdRep->allDiscreteIntLabels[boost::indices[idx_range(
      start, start + num_items)]] = div_labels;
}

inline void SharedVariablesData::all_discrete_int_label(const String& div_label,
                                                        size_t index) {
  svdRep->allDiscreteIntLabels[index] = div_label;
}

inline StringMultiArrayView SharedVariablesData::all_discrete_string_labels(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteStringLabels[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_string_labels(
    StringMultiArrayConstView dsv_labels, size_t start, size_t num_items) {
  svdRep->allDiscreteStringLabels[boost::indices[idx_range(
      start, start + num_items)]] = dsv_labels;
}

inline void SharedVariablesData::all_discrete_string_label(
    const String& dsv_label, size_t index) {
  svdRep->allDiscreteStringLabels[index] = dsv_label;
}

inline StringMultiArrayView SharedVariablesData::all_discrete_real_labels(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteRealLabels[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_real_labels(
    StringMultiArrayConstView drv_labels, size_t start, size_t num_items) {
  svdRep->allDiscreteRealLabels[boost::indices[idx_range(
      start, start + num_items)]] = drv_labels;
}

inline void SharedVariablesData::all_discrete_real_label(
    const String& drv_label, size_t index) {
  svdRep->allDiscreteRealLabels[index] = drv_label;
}

inline UShortMultiArrayConstView SharedVariablesData::all_continuous_types(
    size_t start, size_t num_items) const {
  return svdRep
      ->allContinuousTypes[boost::indices[idx_range(start, start + num_items)]];
}

inline void SharedVariablesData::all_continuous_types(
    UShortMultiArrayConstView cv_types, size_t start, size_t num_items) {
  svdRep->allContinuousTypes[boost::indices[idx_range(
      start, start + num_items)]] = cv_types;
}

inline void SharedVariablesData::all_continuous_type(unsigned short cv_type,
                                                     size_t index) {
  svdRep->allContinuousTypes[index] = cv_type;
}

inline UShortMultiArrayConstView SharedVariablesData::all_discrete_int_types(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteIntTypes[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_int_types(
    UShortMultiArrayConstView div_types, size_t start, size_t num_items) {
  svdRep->allDiscreteIntTypes[boost::indices[idx_range(
      start, start + num_items)]] = div_types;
}

inline void SharedVariablesData::all_discrete_int_type(unsigned short div_type,
                                                       size_t index) {
  svdRep->allDiscreteIntTypes[index] = div_type;
}

inline UShortMultiArrayConstView SharedVariablesData::all_discrete_string_types(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteStringTypes[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_string_types(
    UShortMultiArrayConstView dsv_types, size_t start, size_t num_items) {
  svdRep->allDiscreteStringTypes[boost::indices[idx_range(
      start, start + num_items)]] = dsv_types;
}

inline void SharedVariablesData::all_discrete_string_type(
    unsigned short dsv_type, size_t index) {
  svdRep->allDiscreteStringTypes[index] = dsv_type;
}

inline UShortMultiArrayConstView SharedVariablesData::all_discrete_real_types(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteRealTypes[boost::indices[idx_range(
      start, start + num_items)]];
}

inline void SharedVariablesData::all_discrete_real_types(
    UShortMultiArrayConstView drv_types, size_t start, size_t num_items) {
  svdRep->allDiscreteRealTypes[boost::indices[idx_range(
      start, start + num_items)]] = drv_types;
}

inline void SharedVariablesData::all_discrete_real_type(unsigned short drv_type,
                                                        size_t index) {
  svdRep->allDiscreteRealTypes[index] = drv_type;
}

inline SizetMultiArrayConstView SharedVariablesData::all_continuous_ids(
    size_t start, size_t num_items) const {
  return svdRep
      ->allContinuousIds[boost::indices[idx_range(start, start + num_items)]];
}

inline SizetMultiArrayConstView SharedVariablesData::all_discrete_int_ids(
    size_t start, size_t num_items) const {
  return svdRep
      ->allDiscreteIntIds[boost::indices[idx_range(start, start + num_items)]];
}

inline SizetMultiArrayConstView SharedVariablesData::all_discrete_string_ids(
    size_t start, size_t num_items) const {
  return svdRep->allDiscreteStringIds[boost::indices[idx_range(
      start, start + num_items)]];
}

inline SizetMultiArrayConstView SharedVariablesData::all_discrete_real_ids(
    size_t start, size_t num_items) const {
  return svdRep
      ->allDiscreteRealIds[boost::indices[idx_range(start, start + num_items)]];
}

inline void SharedVariablesData::all_continuous_ids(
    SizetMultiArrayConstView cv_ids, size_t start, size_t num_items) {
  svdRep
      ->allContinuousIds[boost::indices[idx_range(start, start + num_items)]] =
      cv_ids;
}
...
inline const SizetArray& SharedVariablesData::inactive_components_totals()
    const {
...
inline void SharedVariablesData::view(const ShortShortPair& view_pr) const {
  active_view(view_pr.first);
  inactive_view(view_pr.second);
}

inline size_t SharedVariablesData::cv() const { return svdRep->numCV; }

inline size_t SharedVariablesData::cv_start() const { return svdRep->cvStart; }

inline size_t SharedVariablesData::div() const { return svdRep->numDIV; }

inline size_t SharedVariablesData::div_start() const {
  return svdRep->divStart;
}

inline size_t SharedVariablesData::dsv() const { return svdRep->numDSV; }

inline size_t SharedVariablesData::dsv_start() const {
  return svdRep->dsvStart;
}

inline size_t SharedVariablesData::drv() const { return svdRep->numDRV; }

inline size_t SharedVariablesData::drv_start() const {
  return svdRep->drvStart;
}

inline size_t SharedVariablesData::icv() const { return svdRep->numICV; }

inline size_t SharedVariablesData::icv_start() const {
  return svdRep->icvStart;
}

inline size_t SharedVariablesData::idiv() const { return svdRep->numIDIV; }

inline size_t SharedVariablesData::idiv_start() const {
  return svdRep->idivStart;
}

inline size_t SharedVariablesData::idsv() const { return svdRep->numIDSV; }

inline size_t SharedVariablesData::idsv_start() const {
  return svdRep->idsvStart;
}

inline size_t SharedVariablesData::idrv() const { return svdRep->numIDRV; }

inline size_t SharedVariablesData::idrv_start() const {
  return svdRep->idrvStart;
}

inline size_t SharedVariablesData::acv() const { return svdRep->acv(); }

inline size_t SharedVariablesData::adiv() const { return svdRep->adiv(); }

inline size_t SharedVariablesData::adsv() const { return svdRep->adsv(); }

inline size_t SharedVariablesData::adrv() const { return svdRep->adrv(); }

inline void SharedVariablesData::cv(size_t ncv) { svdRep->numCV = ncv; }

inline void SharedVariablesData::cv_start(size_t cvs) { svdRep->cvStart = cvs; }

inline void SharedVariablesData::div(size_t ndiv) { svdRep->numDIV = ndiv; }

inline void SharedVariablesData::div_start(size_t divs) {
  svdRep->divStart = divs;
}

inline void SharedVariablesData::dsv(size_t ndsv) { svdRep->numDSV = ndsv; }

inline void SharedVariablesData::dsv_start(size_t dsvs) {
  svdRep->dsvStart = dsvs;
}

inline void SharedVariablesData::drv(size_t ndrv) { svdRep->numDRV = ndrv; }

inline void SharedVariablesData::drv_start(size_t drvs) {
  svdRep->drvStart = drvs;
}

inline void SharedVariablesData::icv(size_t nicv) { svdRep->numICV = nicv; }

inline void SharedVariablesData::icv_start(size_t icvs) {
  svdRep->icvStart = icvs;
}

inline void SharedVariablesData::idiv(size_t nidiv) { svdRep->numIDIV = nidiv; }

inline void SharedVariablesData::idiv_start(size_t idivs) {
  svdRep->idivStart = idivs;
}

inline void SharedVariablesData::idsv(size_t nidsv) { svdRep->numIDSV = nidsv; }

inline void SharedVariablesData::idsv_start(size_t idsvs) {
  svdRep->idsvStart = idsvs;
}

inline void SharedVariablesData::idrv(size_t nidrv) { svdRep->numIDRV = nidrv; }
