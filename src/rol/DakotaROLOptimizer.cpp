...
void ROLOptimizer::Initializer::set_default_parameters( ROLOptimizer* opt ) {
...
} // ROLOptimizer::Initializer::set_default_parameters
...
//  set_problem();
  ...
  ROL::Solver<Real> opt_solver( problem, parList );
