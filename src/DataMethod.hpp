...
// don't see a way to OR bits using #define and enum, so use more define's
#define   ANA_VERIF_BITS  2304
#define ANA_PSTDACE_BITS  2560
#define    ANA_NOND_BITS  3072
#define    MIN_SURR_BITS 36864
#define     MIN_LSQ_BITS 40960
#define     MIN_OPT_BITS 49152
...
enum { DEFAULT_METHOD=0,
       ...
       RICHARDSON_EXTRAP=ANA_VERIF_BITS,
       // PStudyDACE Analyzers:
       CENTERED_PARAMETER_STUDY=ANA_PSTDACE_BITS, LIST_PARAMETER_STUDY,
       MULTIDIM_PARAMETER_STUDY, VECTOR_PARAMETER_STUDY,
       DACE, FSU_CVT, FSU_HALTON, FSU_HAMMERSLEY, PSUADE_MOAT,
       // NonD Analyzers:
       LOCAL_RELIABILITY=ANA_NOND_BITS, GLOBAL_RELIABILITY,
       ...
       SURROGATE_BASED_LOCAL=MIN_SURR_BITS, SURROGATE_BASED_GLOBAL,
       EFFICIENT_GLOBAL,
       // Gradient-based LeastSq Minimizers:
       NL2SOL=MIN_LSQ_BITS, NLSSOL_SQP, OPTPP_G_NEWTON,
       // Nongradient-based Optimizers / Minimizers:
       ASYNCH_PATTERN_SEARCH=MIN_OPT_BITS, OPTPP_PDS,
       COLINY_BETA, COLINY_COBYLA,         COLINY_DIRECT, COLINY_MULTI_START,
       COLINY_EA,   COLINY_PATTERN_SEARCH, COLINY_SOLIS_WETS,
       MOGA, SOGA, NCSU_DIRECT, MESH_ADAPTIVE_SEARCH, OPT_DARTS,
...
enum { SUBMETHOD_DEFAULT=0,
       ...
       SUBMETHOD_INCREMENTAL_LHS, SUBMETHOD_INCREMENTAL_RANDOM,
