...
typedef std::map<UShortArray, IntRealVectorMap> UShortArrayIntRealVector2DMap;
...
typedef std::map<UShortArray, IntVariablesMap> UShortArrayIntVariables2DMap;
typedef std::map<int, Response>        IntResponseMap;
typedef std::vector<IntResponseMap>    IntResponseMapArray;
typedef std::map<UShortArray, IntResponseMap> UShortArrayIntResponse2DMap;
