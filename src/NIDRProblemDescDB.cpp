...
static Method_mp_type
	...
	MP2s(expansionBasisType,ADAPTED_BASIS),
	MP2s(expansionBasisType,HIERARCHICAL_INTERPOLANT),
	MP2s(expansionBasisType,NODAL_INTERPOLANT),
	MP2s(expansionBasisType,TENSOR_PRODUCT_BASIS),
	MP2s(expansionBasisType,TOTAL_ORDER_BASIS),
