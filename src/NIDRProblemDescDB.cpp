...
static bool
	...
	MP_(importPtsActive),
	MP_(importPtsUseVariableLabels),
	MP_(latinizeFlag),
	MP_(logitTransform),
	MP_(mainEffectsFlag),
	MP_(methodScaling),
...
static Method_mp_utype
	...
	MP2s(calibrateErrorMode,CALIBRATE_BOTH),
        ...
        MP2s(importPtsFormat,TABULAR_NONE),
        MP2s(importPtsFormat,TABULAR_HEADER),
        MP2s(importPtsFormat,TABULAR_EVAL_ID),
        MP2s(importPtsFormat,TABULAR_IFACE_ID),
        MP2s(importPtsFormat,TABULAR_ANNOTATED),
	...
	MP2s(methodName,EXTERNAL_PYTHON),
