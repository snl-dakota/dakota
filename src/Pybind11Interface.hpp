...
class Pybind11Interface : public DirectApplicInterface {
 public:
  ...
  void register_pybind11_callback_fns(
      const std::map<String, py::function>& callbacks);
 ...
 private:
  ...
  RetT copy_array_to_pybind11(
      const Teuchos::SerialDenseVector<OrdinalType, ScalarType>& src) const;
  ...
  void unpack_python_response(const ShortArray& asv, const size_t num_derivs,
                              const pybind11::dict& py_response,
                              RealVector& fn_values, RealMatrix& gradients,
...
inline void Pybind11Interface::register_pybind11_callback_fn(
