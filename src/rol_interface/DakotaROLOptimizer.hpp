...
class Optimizer : public Dakota::Optimizer {
 public:
  ...
  Optimizer(Dakota::ProblemDescDB& problem_db, Dakota::Model& model);

  /// Alternate constructor for Iterator instantiations by name
  Optimizer(const Dakota::String& method_name, Dakota::Model& model);
  ...
  inline std::shared_ptr<Dakota::Optimizer> create(
