...
Optimizer::Optimizer(Dakota::ProblemDescDB& problem_db, Dakota::Model& model)
    : Dakota::Optimizer(problem_db, model, Traits::create()),
...
Optimizer::Optimizer(const Dakota::String& method_string, Model& model)
    : Dakota::Optimizer(Dakota::method_string_to_enum(method_string), model,
                        Traits::create()),
      modelInterface(ROL::makePtr<ModelInterface>(this)) {
