...
NonDMultilevelStochCollocation::NonDMultilevelStochCollocation(
    ...
    : NonDStochCollocation(DEFAULT_METHOD, problem_db, parallel_lib,
                           model),  // bypass SC ctor
...
NonDMultilevelStochCollocation::NonDMultilevelStochCollocation(
    ...
    short covar_control, short ml_alloc_cntl, short ml_discrep, short rule_nest,
    short rule_growth, bool piecewise_basis, bool use_derivs)
    : NonDStochCollocation(
          MULTIFIDELITY_STOCH_COLLOCATION, model, exp_coeffs_approach, dim_pref,
          refine_type, refine_control, covar_control, ml_alloc_cntl, ml_discrep,
...
void NonDMultilevelStochCollocation::increment_specification_sequence() {
  switch (expansionCoeffsApproach) {
    ...
    default:
      Cerr << "Error: unsupported expansion coefficient estimation approach in "
           << "NonDMultilevelStochCollocation::increment_specification_"
              "sequence()"
           << std::endl;
      abort_handler(METHOD_ERROR);
      break;
...
void NonDMultilevelStochCollocation::print_results(std::ostream& s,
                                                   short results_state) {
