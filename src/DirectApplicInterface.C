...
#ifdef DAKOTA_SCILAB
  if (contains(analysisDriverTypes, SCILAB)) {
...
#endif
    if ( scilabEngine !=0 ) {
      Cerr << "Error (Direct:Scilab): Could not initialize Scilab engine "
	   << "for direct fn. eval." << std::endl;
      abort_handler(-1);
    }
    else {
...
#ifdef DAKOTA_SCILAB
  if (contains(analysisDriverTypes, SCILAB) && (scilabEngine==0))
    if (TerminateScilab(NULL) == FALSE) {
      Cerr << "Error (Direct:Scilab): Couldn't terminate Scilab engine post "
	   << "direct fn. eval." << std::endl;
      abort_handler(-1);
    } 
    else if (outputLevel >= NORMAL_OUTPUT) {
...
#ifdef DAKOTA_SCILAB
  case SCILAB:
    fail_code = scilab_engine_run(); break;
#endif //DAKOTA_SCILAB
#ifdef DAKOTA_PYTHON
  case PYTHON:
...
#ifdef DAKOTA_SCILAB
int DirectApplicInterface::scilab_engine_run()
{
  ...
  sci_err = createNamedMList(pvApiCtx, "Dakota", SCI_NUMBER_OF_FIELDS, 
			     &piMListAddr);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed creating mlist Dakota."<< std::endl;
 ...
 if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting field names" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 2, 
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numFns" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 3,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numVars" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 4,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numACV" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 5,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numADIV" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 6,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numADRV" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx,"Dakota", piMListAddr, 7,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting numDerivVars" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 8,
				    1, numACV, xC.values());
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xC" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xDI" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xDR" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  free(pstStringsTmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xCLabels" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  free(pstStringsTmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xDILabels" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  free(pstStringsTmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting xDRLabels" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting directFnASV" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  //delete [] x_tmp;
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting directFnASM" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting directFnDVV" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  //delete [] x_tmp;
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting directFnDVV_bool" 
	 << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 18,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting fnFlag" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 19,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting gradFlag" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 20,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting hessFlag" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting fnVals" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting fnGrads" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  if (hessFlag) {
    ...
    if (sci_err.iErr) {
      Cerr << "Error (Direct:Scilab): Failed inserting fnHessians list" 
	   << std::endl;
      printError(&sci_err,0);
      return (SCILAB_FAIL);
    }
	...
	createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piListInMList, 23,
					0, 0, &dbl_tmp);
      if (sci_err.iErr) {
	Cerr << "Error (Direct:Scilab): Failed inserting fnHessians" 
	     << std::endl;
	printError(&sci_err,0);
	return (SCILAB_FAIL);
      }
  ...
  free(pstStringsTmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting fnLabels" << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 25,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting failure field" << std::endl;
    printError(&sci_err,0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = 
    createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr,26,
				    1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed inserting currEvalId field" 
	 << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  for (int aci=0; aci<analysisComponents[analysisDriverIndex].size(); aci++) {
    ...
    if (testJob == -1) {
      ...
      Cerr << "Error (Direct:Scilab): Call Scilab has not been able to read "
	   << "the error code from Scilab." << std::endl;
      return (SCILAB_FAIL);
    }
    else if (testJob == -4) {
      Cerr << "Error (Direct:Scilab): Call Scilab has not been able to " 
  ...
  if (sci_err.iErr) {
    Cerr << "Error (Direct:Scilab): Failed to get variable Dakota_out from "
	 << "Scilab." << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err =
    ...
    Cerr << "Error (Direct:Scilab): Returned fields don't match." << std::endl;
    return (SCILAB_FAIL);
  }
