...
class C3FnTrainDataRep {
 public:
  ...
  static struct FunctionTrain* subtract_const(struct FunctionTrain* ft,
                                              double val,
  ...
  void ft_derived_functions_create(struct MultiApproxOpts* opts, size_t num_mom,
                                   double eps);
...
inline struct FunctionTrain* C3FnTrainDataRep::subtract_const(
    struct FunctionTrain* ft, double val, struct MultiApproxOpts* opts) {
...
inline void C3FnTrainDataRep::free_ft() {
  ...
  if (ft_gradient) {
    ft1d_array_free(ft_gradient);
    ft_gradient = NULL;
  }
  if (ft_hessian) {
    ft1d_array_free(ft_hessian);
    ft_hessian = NULL;
  }
}
...
inline C3FnTrainDataRep::~C3FnTrainDataRep() { free_all(); }
...
inline void C3FnTrainData::swap(C3FnTrainData& ftd) { ftdRep.swap(ftd.ftdRep); }

// Note: the following functions init/create/free ft memory within an ftdRep
//       but do not alter ftdRep accounting

inline void C3FnTrainData::free_ft() { ftdRep->free_ft(); }

inline void C3FnTrainData::free_all() { ftdRep->free_all(); }

inline void C3FnTrainData::ft_derived_functions_init_null() {
  ftdRep->ft_derived_functions_init_null();
}

inline void C3FnTrainData::ft_derived_functions_create(
    struct MultiApproxOpts* ma_opts, size_t num_mom, Real round_tol) {
  ftdRep->ft_derived_functions_create(ma_opts, num_mom, round_tol);
}

inline void C3FnTrainData::ft_derived_functions_create_av(
    struct MultiApproxOpts* ma_opts, const SizetArray& rand_indices,
    Real round_tol) {
...
inline RealVector& C3FnTrainData::moments() { return ftdRep->primaryMoments; }
