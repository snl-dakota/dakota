...
static const char rcsId[] =
    "@(#) $Id: ParamResponsePair.cpp 6715 2010-04-02 21:58:15Z wjbohnh $";
...
void ParamResponsePair::write_tabular(std::ostream& s,
  ...
  TabularIO::write_leading_columns(s, evalInterfaceIds.first,
                                   evalInterfaceIds.second, tabular_format);
...
void ParamResponsePair::write_tabular_labels(
    std::ostream& s, unsigned short tabular_format) const {
...
template void ParamResponsePair::serialize<boost::archive::binary_iarchive>(
    boost::archive::binary_iarchive& ar, const unsigned int version);
template void ParamResponsePair::serialize<boost::archive::binary_oarchive>(
