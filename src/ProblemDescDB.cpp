...
{  
  ...
  ( "get_rv()",
    ...
    { /* variables */
      ...
      {"lognormal_uncertain.inferred_lower_bounds",
          P_VAR lognormalUncInferredLowerBnds},
...
const String& ProblemDescDB::get_string(const String& entry_name) const
{
  ...
  ( "get_string()",
    ...
    { /* method */
      ...
      {"import_points_file", P_MET importPtsFile},
...
unsigned short ProblemDescDB::get_ushort(const String& entry_name) const
{
  ...
  ( "get_ushort()",
    ...
    { /* method */
      ...
      {"import_points_format", P_MET importPtsFormat},
...
bool ProblemDescDB::get_bool(const String& entry_name) const
{
  ...
  ( "get_bool()",
    ...
    { /* method */
      ...
      {"import_points.active_only", P_MET importPtsActive},
      {"import_points.use_variable_labels", P_MET importPtsUseVariableLabels},
