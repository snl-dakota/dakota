...
const char *SCI_FIELD_NAMES[] = {
    "dakota_type", "numFns",           "numVars",     "numACV", "numADIV",  // 0
...
int ScilabInterface::scilab_engine_run(const String &ac_name) {
  ...
  sci_err =
      createNamedMList(pvApiCtx, "Dakota", SCI_NUMBER_OF_FIELDS, &piMListAddr);
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed creating mlist Dakota."
         << std::endl;
  ...
  sci_err =
      createMatrixOfStringInNamedList(pvApiCtx, "Dakota", piMListAddr, 1, 1,
                                      SCI_NUMBER_OF_FIELDS, SCI_FIELD_NAMES);
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting field names"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  // Insert numFns
  dbl_tmp = numFns;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 2,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // numVars
  dbl_tmp = numVars;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 3,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // numACV
  dbl_tmp = numACV;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 4,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // numADIV
  dbl_tmp = numADIV;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 5,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // numADRV
  dbl_tmp = numADRV;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 6,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 7,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting numDerivVars"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 8,
                                            1, numACV, xC.values());
  if (sci_err.iErr) {
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 9,
  ...
  sci_err = createMatrixOfStringInNamedList(pvApiCtx, "Dakota", piMListAddr, 11,
  ...
  sci_err = createMatrixOfStringInNamedList(pvApiCtx, "Dakota", piMListAddr, 12,
  ...
  sci_err = createMatrixOfStringInNamedList(pvApiCtx, "Dakota", piMListAddr, 13,
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 14,
                                            1, numFns, asv_tmp.values());
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting directFnASV"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  for (i = 0; i < 3; i++) {
    for (j = 0; j < numFns; j++) {
      // FIX THIS MESS!
      (directFnASV[j] & RESPONSE_TYPES[i]) ? (x_tmp[3 * j + i] = 1)
                                           : (x_tmp[3 * j + i] = 0);
    }
  }
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 15,
                                            3, numFns, x_tmp);
  free(x_tmp);
  // delete [] x_tmp;
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting directFnASM"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 16,
                                            1, numDerivVars, dvv_tmp.values());
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting directFnDVV"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 17,
  ...
  dbl_tmp = fn_flag;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 18,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // gradFlag
  dbl_tmp = gradFlag;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 19,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // hessFlag
  dbl_tmp = hessFlag;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 20,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  // fnVals
  if (fn_flag) {
    sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr,
                                              21, 1, numFns, fnVals.values());
  } else {
    dbl_tmp = 0;
    sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr,
                                              21, 0, 0, &dbl_tmp);
  ...
  if (hessFlag) {
    ...
    sci_err = createListInNamedList(pvApiCtx, "Dakota", piMListAddr, 23, numFns,
                                    &piListInMList);
    if (sci_err.iErr) {
    ...
    for (i = 0; i < numFns; i++) {
      dbl_tmp = 0;
      sci_err = createMatrixOfDoubleInNamedList(
          pvApiCtx, "Dakota", piListInMList, 23, 0, 0, &dbl_tmp);
      if (sci_err.iErr) {
  ...
  sci_err = createMatrixOfStringInNamedList(pvApiCtx, "Dakota", piMListAddr, 24,
                                            1, xDRLabels.size(), pstStringsTmp);
  free(pstStringsTmp);
  if (sci_err.iErr) {
  ...
  // failure
  dbl_tmp = 0;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 25,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
    Cerr << "Error (ScilabInterface): Failed inserting failure field"
         << std::endl;
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
  ...
  // currEvalId
  dbl_tmp = currEvalId;
  sci_err = createMatrixOfDoubleInNamedList(pvApiCtx, "Dakota", piMListAddr, 26,
                                            1, 1, &dbl_tmp);
  if (sci_err.iErr) {
  ...
  if (env_scilab_postevalcmd) SendScilabJob(env_scilab_postevalcmd);
  ...
  sci_err = readMatrixOfStringInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                          1, &piRows, &piCols, NULL, NULL);
  piLength = (int *)malloc(sizeof(int) * piRows * piCols);
  sci_err = readMatrixOfStringInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                          1, &piRows, &piCols, piLength, NULL);
  ...
  if (strcmp(pstStrings[0], SCI_FIELD_NAMES[0]) != 0) {
    Cerr << "Error (ScilabInterface): Returned fields don't match."
         << std::endl;
    return (SCILAB_FAIL);
  }
  // free temporary memory
  for (i = 0; i < piRows * piCols; i++) free(pstStrings[i]);
  free(pstStrings);
  free(piLength);
  ...
  sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                          25, &piRows, &piCols, NULL);
  x_tmp = (double *)malloc(sizeof(double) * piRows * piCols);
  sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                          25, &piRows, &piCols, x_tmp);
  ...
  if (fn_flag) {
    sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                            21, &piRows, &piCols, NULL);

    x_tmp = (double *)malloc(sizeof(double) * piRows * piCols);

    sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                            21, &piRows, &piCols, x_tmp);
  ...
  if (gradFlag) {
    sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                            22, &piRows, &piCols, NULL);

    x_tmp = (double *)malloc(sizeof(double) * piRows * piCols);

    sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                            22, &piRows, &piCols, x_tmp);
    if (sci_err.iErr) {
      printError(&sci_err, 0);
      return (SCILAB_FAIL);
    }
  ...
  if (hessFlag) {
    ...
    if (piRows != numFns | piCols != numDerivVars) {
      ...
      for (i = 0; i < numFns; i++) {
        ...
        sci_err = readMatrixOfDoubleInNamedList(pvApiCtx, "Dakota_out",
                                                piMListAddrHess, i + 1, &piRows,
                                                &piCols, pdblReal);
        if (sci_err.iErr) {
          printError(&sci_err, 0);
          return (SCILAB_FAIL);
        ...
        for (j = 0; j < numDerivVars; ++j) {
          for (k = 0; k < numDerivVars; ++k) {
            fnHessians[i](j, k) +=
                pdblReal[numDerivVars * numFns * k + numFns * j + i];
          }
        }
      }
    }
  ...
  sci_err = readMatrixOfStringInNamedList(pvApiCtx, "Dakota_out", piMListAddr,
                                          24, &piRows, &piCols, piLength, NULL);
  if (sci_err.iErr) {
    printError(&sci_err, 0);
    return (SCILAB_FAIL);
  }
