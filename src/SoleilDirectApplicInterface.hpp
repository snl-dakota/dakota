...
inline void SoleilDirectApplicInterface::derived_map_asynch(
...
inline void SoleilDirectApplicInterface::test_local_evaluations(
...
inline void SoleilDirectApplicInterface::set_communicators_checks(
