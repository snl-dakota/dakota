...
struct FunctionMonitor *function_monitor_initnd(double (*)(const double *,
                                                           void *),
                                                void *, size_t, size_t);
...
struct FunctionTrain *function_train_integrate_weighted_subset(
...
double function_train_inner_weighted(const struct FunctionTrain *,
                                     const struct FunctionTrain *);
struct FunctionTrain *function_train_sum(const struct FunctionTrain *,
                                         const struct FunctionTrain *);
struct FunctionTrain *function_train_round(struct FunctionTrain *, double,
                                           struct MultiApproxOpts *);
struct FunctionTrain *function_train_product(const struct FunctionTrain *,
                                             const struct FunctionTrain *);
int function_train_save(struct FunctionTrain *, char *);
void function_train_sobol_sensitivities(const struct FunctionTrain *, double *,
                                        double *, size_t);
...
void multi_approx_opts_set_dim(struct MultiApproxOpts *, size_t,
                               struct OneApproxOpts *);

void c3axpy(double a, struct FunctionTrain *x, struct FunctionTrain **y,
            double epsilon, struct MultiApproxOpts *opts);

// sobol sensitivities;
struct C3SobolSensitivity;
struct C3SobolSensitivity *c3_sobol_sensitivity_calculate(
    const struct FunctionTrain *, size_t);
...
double c3_sobol_sensitivity_get_interaction(const struct C3SobolSensitivity *,
                                            size_t, const size_t *);
double c3_sobol_sensitivity_get_total(const struct C3SobolSensitivity *,
                                      size_t);
...
struct FTRegress;
struct FTRegress *ft_regress_alloc(size_t dim, struct MultiApproxOpts *,
                                   size_t *ranks);
...
void ft_regress_reset_param(struct FTRegress *, struct MultiApproxOpts *,
                            size_t *);
...
struct FunctionTrain *ft_regress_run(struct FTRegress *, struct c3Opt *, size_t,
                                     const double *xdata, const double *ydata);

// cross validation
struct CrossValidate;
void cross_validate_free(struct CrossValidate *);
struct CrossValidate *cross_validate_init(size_t, size_t, const double *,
                                          const double *, size_t, int);
double cross_validate_run(struct CrossValidate *, struct FTRegress *,
                          struct c3Opt *);
...
void cross_validate_grid_opt(struct CrossValidate *, struct CVOptGrid *,
                             struct FTRegress *, struct c3Opt *);
}
