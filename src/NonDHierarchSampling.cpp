...
static const char rcsId[] =
    "@(#) $Id: NonDHierarchSampling.cpp 7035 2010-10-22 21:45:39Z mseldre $";
...
NonDHierarchSampling::NonDHierarchSampling(ProblemDescDB& problem_db,
...
void NonDHierarchSampling::ensemble_sample_batch(const String& prepend,
                                                 int batch_id,
                                                 bool new_samples) {
  if (new_samples) {
...
void NonDHierarchSampling::export_all_samples(String root_prepend,
                                              const Model& model, size_t iter,
                                              int batch_id) {
