...
static const char rcsId[] =
    "@(#) $Id: MinimizerAdapterModel.cpp 7029 2010-10-22 00:17:02Z mseldre $";
...
/** Default constructor.  Includes full definition of a minimization
    sub-problem. */
MinimizerAdapterModel::MinimizerAdapterModel(
    const RealVector& cv_initial_pt,  //, di_vars, dr_vars, ...
...
MinimizerAdapterModel::MinimizerAdapterModel(void (*resp_map)(
