...
class ScalingModel : public RecastModel {
 public:
  ...
  void response_modify_s2n(const Variables& native_vars,
                           ...
                           Response& native_response, int start_offset,
                           int num_responses,
 ...
 protected:
  ...
  void compute_scaling(int auto_type, int num_vars, RealVector& lbs,
                       RealVector& ubs, RealVector& targets,
  ...
  void response_modify_n2s(const Variables& scaled_vars,
                           const Response& native_response,
                           Response& scaled_response, int start_offset,
...
inline void ScalingModel::assign_instance() { scaleModelInstance = this; }
