...
protected:
  ...
  /// combine coefficients, promote to active, and update statsMetricRollUp
  ...
  /// update statsMetricRollUp, here and in Pecos::ExpansionConfigOptions
  ...
  /// the expansion indicated by statsMetricRollUp
