...
static const char rcsId[] =
    "@(#) $Id: DakotaIterator.cpp 7029 2010-10-22 00:17:02Z mseldre $";
...
std::map<const ProblemDescDB*, std::list<std::shared_ptr<Iterator>>>
    Iterator::iteratorCache{};
...
/** This constructor builds the base class data for all inherited
    ...
    set to NULL */
Iterator::Iterator(ProblemDescDB& problem_db, ParallelLibrary& parallel_lib,
                   std::shared_ptr<TraitsBase> traits)
    : probDescDB(problem_db),
      parallelLib(parallel_lib),
      methodPCIter(parallelLib.parallel_configuration_iterator()),
      myModelLayers(0),
      methodName(problem_db.get_ushort("method.algorithm")),
      ...
      // where "silent," "quiet", "verbose" and "debug" must be user specified
      // and "normal" is the default for no user specification.  Note that
      // iterators and interfaces have the most granularity in verbosity.
      outputLevel(problem_db.get_short("method.output")),
      summaryOutputFlag(true),
      topLevel(false),
      resultsDB(iterator_results_db),
      evaluationsDB(evaluation_store_db),
      evaluationsDBState(EvaluationsDBState::UNINITIALIZED),
      methodId(problem_db.get_string("method.id")),
      execNum(0),
      methodTraits(traits),
      exportSurrogate(problem_db.get_bool("method.export_surrogate")),
      ...
      // default construct a Model so instantiation of MetaIterators won't fail
      // when eval_prefix_id, which requires a model instance, is called from
      // Iterator::init_communicators.
      iteratedModel(std::make_shared<Model>()) {
  if (methodId.empty()) methodId = user_auto_id();
...
Iterator::Iterator(unsigned short method_name, std::shared_ptr<Model> model,
                   std::shared_ptr<TraitsBase> traits)
    : probDescDB(dummy_db),
      parallelLib(model->parallel_library()),
      methodPCIter(parallelLib.parallel_configuration_iterator()),
      myModelLayers(0),
      iteratedModel(model),
      ...
      maxEvalConcurrency(1),
      subIteratorFlag(false),
      numFinalSolutions(1),
      outputLevel(model->output_level()),
      summaryOutputFlag(false),
      topLevel(false),
      resultsDB(iterator_results_db),
      evaluationsDB(evaluation_store_db),
      evaluationsDBState(EvaluationsDBState::UNINITIALIZED),
...
/** This alternate constructor builds base class data for inherited iterators.
    It is used for on-the-fly instantiations for which DB queries cannot be
    used, and is not used for construction of meta-iterators. */
Iterator::Iterator(std::shared_ptr<Model> model, size_t max_iter,
    ...
    : probDescDB(dummy_db),
      ...
      methodPCIter(parallelLib.parallel_configuration_iterator()),
      myModelLayers(0),
      iteratedModel(model),  // methodName(method_name),
...
static UShortStrBimap method_map =
    boost::assign::list_of<UShortStrBimap::relation>(HYBRID, "hybrid")(
        PARETO_SET, "pareto_set")(MULTI_START, "multi_start")(
        ...
        RICHARDSON_EXTRAP, "richardson_extrap")(LOCAL_RELIABILITY,
                                                "local_reliability")(
        LOCAL_INTERVAL_EST, "local_interval_est")(LOCAL_EVIDENCE,
                                                  "local_evidence")(
        GLOBAL_RELIABILITY, "global_reliability")(GLOBAL_INTERVAL_EST,
                                                  "global_interval_est")(
        GLOBAL_EVIDENCE, "global_evidence")(SURROGATE_BASED_UQ,
                                            "surrogate_based_uq")(
        POLYNOMIAL_CHAOS, "polynomial_chaos")(MULTIFIDELITY_POLYNOMIAL_CHAOS,
        ...
        C3_FUNCTION_TRAIN, "c3_function_train")(MULTIFIDELITY_FUNCTION_TRAIN,
                                                "multifidelity_function_train")(
        MULTILEVEL_FUNCTION_TRAIN, "multilevel_function_train")(
        BAYES_CALIBRATION, "bayes_calibration")(
        CUBATURE_INTEGRATION, "cubature")(QUADRATURE_INTEGRATION, "quadrature")(
        SPARSE_GRID_INTEGRATION, "sparse_grid")(GPAIS, "gpais")(
        POF_DARTS, "pof_darts")(RKD_DARTS, "rkd_darts")(IMPORTANCE_SAMPLING,
                                                        "importance_sampling")(
        ADAPTIVE_SAMPLING, "adaptive_sampling")(RANDOM_SAMPLING,
                                                "random_sampling")(
        MULTILEVEL_SAMPLING, "multilevel_sampling")(MULTIFIDELITY_SAMPLING,
        ...
        MULTILEVEL_BLUE, "multilevel_blue")(LIST_SAMPLING, "list_sampling")(
        ...
        EFFICIENT_GLOBAL, "efficient_global")(NONLINEAR_CG, "nonlinear_cg")(
        GENIE_DIRECT, "genie_direct")(GENIE_OPT_DARTS, "genie_opt_darts")(
        OPTPP_G_NEWTON, "optpp_g_newton")(OPTPP_Q_NEWTON, "optpp_q_newton")(
        OPTPP_FD_NEWTON, "optpp_fd_newton")(OPTPP_NEWTON, "optpp_newton")(
        OPTPP_CG, "optpp_cg")(OPTPP_PDS, "optpp_pds")(ASYNCH_PATTERN_SEARCH,
                                                      "asynch_pattern_search")(
        COLINY_BETA, "coliny_beta")(COLINY_COBYLA, "coliny_cobyla")(
        COLINY_DIRECT, "coliny_direct")(COLINY_EA, "coliny_ea")(
        COLINY_PATTERN_SEARCH, "coliny_pattern_search")(COLINY_SOLIS_WETS,
                                                        "coliny_solis_wets")(
        BRANCH_AND_BOUND, "branch_and_bound")(MOGA, "moga")(SOGA, "soga")(
        DL_SOLVER, "dl_solver")(MESH_ADAPTIVE_SEARCH, "mesh_adaptive_search")(
        MIT_NOWPAC, "nowpac")(MIT_SNOWPAC, "snowpac")(NPSOL_SQP, "npsol_sqp")(
        NLSSOL_SQP, "nlssol_sqp")(NLPQL_SQP, "nlpql_sqp")(NL2SOL, "nl2sol")
    //(REDUCED_SQP,                   "reduced_sqp")
    (DOT_BFGS, "dot_bfgs")(DOT_FRCG, "dot_frcg")(DOT_MMFD, "dot_mmfd")(
        DOT_SLP, "dot_slp")(DOT_SQP, "dot_sqp")(CONMIN_FRCG, "conmin_frcg")(
        CONMIN_MFD, "conmin_mfd")(DACE, "dace")(FSU_CVT, "fsu_cvt")(
        FSU_HALTON, "fsu_halton")(FSU_HAMMERSLEY, "fsu_hammersley")(
        PSUADE_MOAT, "psuade_moat")(NCSU_DIRECT, "ncsu_direct")(ROL, "rol")(
        DEMO_TPL, "demo_tpl");
...
static UShortStrBimap submethod_map =
    boost::assign::list_of<UShortStrBimap::relation>(HYBRID, "hybrid")(
        ...
        SUBMETHOD_EMBEDDED, "embedded")(SUBMETHOD_SEQUENTIAL, "sequential")(
        SUBMETHOD_LHS, "lhs")(SUBMETHOD_LOW_DISCREPANCY_SAMPLING,
                              "low_discrepancy")(SUBMETHOD_RANDOM, "random")(
        SUBMETHOD_BOX_BEHNKEN, "box_behnken")(SUBMETHOD_CENTRAL_COMPOSITE,
                                              "central_composite")(
        SUBMETHOD_GRID, "grid")(SUBMETHOD_OA_LHS, "oa_lhs")(
        SUBMETHOD_OAS, "oas")(SUBMETHOD_ACV_IS, "acv_is")(
        SUBMETHOD_ACV_MF, "acv_mf")(SUBMETHOD_ACV_RD, "acv_rd")(
        SUBMETHOD_DREAM, "dream")(SUBMETHOD_WASABI, "wasabi")(
        SUBMETHOD_GPMSA, "gpmsa")(SUBMETHOD_MUQ, "muq")(
        SUBMETHOD_QUESO, "queso")(SUBMETHOD_OPTPP, "nip")(
        SUBMETHOD_NPSOL, "sqp")(SUBMETHOD_NPSOL_OPTPP, "sqp_nip")(
        SUBMETHOD_DIRECT, "direct")(SUBMETHOD_EA, "ea")(SUBMETHOD_EGO, "ego")(
        SUBMETHOD_SBGO, "sbgo")(SUBMETHOD_CONVERGE_ORDER, "converge_order")(
        SUBMETHOD_CONVERGE_QOI, "converge_qoi")(SUBMETHOD_ESTIMATE_ORDER,
                                                "estimate_order");
...
String Iterator::method_enum_to_string(unsigned short method_enum) {
  ...
  if (lc_iter == method_map.left.end()) {
    Cerr << "\nError: Invalid method_enum_to_string conversion: " << method_enum
...
unsigned short Iterator::method_string_to_enum(const String& method_str) {
  ...
  if (rc_iter == method_map.right.end()) {
    Cerr << "\nError: Invalid method_string_to_enum conversion: " << method_str
         << " not available." << std::endl;
    abort_handler(METHOD_ERROR);
  }
...
std::shared_ptr<Iterator> Iterator::get_iterator(
  ...
  if (id_method.empty()) id_method = "NO_METHOD_ID";
  auto i_it = std::find_if(study_cache.begin(), study_cache.end(),
                           [&id_method](std::shared_ptr<Iterator> iter) {
                             return iter->method_id() == id_method;
                           });
  if (i_it == study_cache.end()) {
    study_cache.push_back(
        IteratorUtils::get_iterator(problem_db, parallel_lib));
...
std::shared_ptr<Iterator> Iterator::get_iterator(ProblemDescDB& problem_db,
  ...
  if (i_it == study_cache.end()) {
    study_cache.push_back(
        IteratorUtils::get_iterator(problem_db, parallel_lib, model));
    i_it = --study_cache.end();
  }
...
std::shared_ptr<Iterator> Iterator::get_iterator(const String& method_name,
                                                 std::shared_ptr<Model> model) {
  auto i_it = std::find_if(Iterator::iteratorByNameCache.begin(),
                           Iterator::iteratorByNameCache.end(),
                           [&method_name](std::shared_ptr<Iterator> iter) {
                             return iter->method_string() == method_name;
                           });
  // if Iterator does not already exist, then create it
  if (i_it == Iterator::iteratorByNameCache.end()) {
    Iterator::iteratorByNameCache.push_back(
        IteratorUtils::get_iterator(method_name, model));
...
std::list<std::shared_ptr<Iterator>>& Iterator::iterator_cache(
...
void Iterator::run() {
  ...
  if (evaluationsDBState == EvaluationsDBState::UNINITIALIZED) {
    ...
    if (evaluationsDBState == EvaluationsDBState::ACTIVE) declare_sources();
  }
...
bool Iterator::top_level() { return topLevel; }

void Iterator::top_level(bool flag) { topLevel = flag; }
...
void Iterator::pack_parameters_buffer(MPIPackBuffer& send_buffer,
                                      int job_index) {
...
void Iterator::unpack_results_buffer(MPIUnpackBuffer& recv_buffer,
                                     int job_index) {
...
const RealSymMatrix& Iterator::response_error_estimates() const {
  Cerr << "Error: letter class does not redefine response_error_estimates "
       << "virtual fn.\nNo default defined at base class." << std::endl;
  abort_handler(METHOD_ERROR);
  throw METHOD_ERROR;  // never reached; prevents MSVS from squawking about lack
                       // of function return
}
...
void Iterator::update_callback_data(
...
const RealMatrix& Iterator::callback_linear_ineq_coefficients() const {
  Cerr << "Error: letter class does not redefine callback_linear_ineq_"
       ...
       << "class." << std::endl;
  abort_handler(METHOD_ERROR);
  throw METHOD_ERROR;  // never reached; silences warnings/errors on some
                       // compilers about lack of return
}
...
bool Iterator::accepts_multiple_points() const { return false; }

bool Iterator::returns_multiple_points() const { return false; }

/** For Gauss-Newton Hessian requests, activate the 2 bit and mask the 4 bit. */
void Iterator::gnewton_set_recast(const Variables& recast_vars,
...
size_t Iterator::num_samples() const { return 0; }

void Iterator::sampling_reset(size_t min_samples, bool all_data_flag,
                              bool stats_flag) {
...
bool Iterator::compact_mode() const { return false; }

IntIntPair Iterator::estimate_partition_bounds() {
  return iteratedModel->estimate_partition_bounds(
      maxEvalConcurrency);  // default defn
}
...
void Iterator::nested_variable_mappings(
...
void Iterator::nested_response_mappings(const RealMatrix& primary_coeffs,
                                        const RealMatrix& secondary_coeffs) {
  // no op
}

StrStrSizet Iterator::run_identifier() const {
  return (boost::make_tuple(method_enum_to_string(methodName), method_id(),
                            execNum));
}
...
void Iterator::pre_output() {
  ...
  if (!parallelLib.user_modes().requestedUserModes) return;
...
/** Rationale: The parser allows multiple user-specified methods with
    ...
    one parsed"). Therefore decided to prefer NO_METHOD_ID over
   NO_METHOD_ID_<num> for (partial) consistency with interface NO_ID convention.
   The addition of _METHOD_ is it distinguish methods, models and interfaces in
   the HDF5 output. */
...
void Iterator::export_final_surrogates(Model& data_fit_surr_model) {
  ...
  for (; approx_it != approxs.end(); ++rlabel_it, ++approx_it) {
    ...
    approx_it->export_model(vars, *rlabel_it, surrExportPrefix,
                            surrExportFormat);
  }
}
