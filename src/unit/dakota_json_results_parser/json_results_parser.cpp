...
TEST(json_results_parser_tests, test_construct_with_empty_object_throws) {
  json j;
  EXPECT_THROW(JRP test(j),
               JRPE);  //, msg_matches("JSON results is not an object"));
}
...
TEST(json_results_parser_tests, test_no_metadata_object_throws) {
  ...
  // msg_matches("JSON results object does not contain 'metadata', or it's not
  // an object"));
}
...
TEST(json_results_parser_tests, test_missing_metadata_label_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.metadata("time"), JRPE);
  // msg_matches("'metadata' object in JSON results object does not contain
  // 'time'"));
}
...
TEST(json_results_parser_tests, test_metadata_non_numeric_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.metadata("time"), JRPE);
  // msg_matches("In JSON results object, metadata value for 'time' could not be
...
TEST(json_results_parser_tests, test_no_functions_object_throws) {
  ...
  // msg_matches("JSON results object does not contain 'functions', or it's not
  // an object"));
}
...
TEST(json_results_parser_tests, test_missing_function_label_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.function("response_fn_1"), JRPE);
  // msg_matches("'functions' object in JSON results object does not contain
  // 'response_fn_1'"));
}
...
TEST(json_results_parser_tests, test_function_non_numeric_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.function("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, function value for 'response_fn_1'
...
TEST(json_results_parser_tests, test_no_gradients_object_throws) {
  ...
  // msg_matches("JSON results object does not contain 'gradients', or it's not
  // an object"));
}
...
TEST(json_results_parser_tests, test_missing_gradient_label_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.gradient("response_fn_1"), JRPE);
  // msg_matches("'gradients' object in JSON results object does not contain
  // 'response_fn_1'"));
}
...
TEST(json_results_parser_tests, test_gradient_not_array_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.gradient("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, gradient for 'response_fn_1' is not an
  // array"));
}
...
TEST(json_results_parser_tests, test_gradient_non_numeric_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.gradient("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, gradient for 'response_fn_1' contains
...
TEST(json_results_parser_tests, test_no_hessianss_object_throws) {
  ...
  // msg_matches("JSON results object does not contain 'hessians', or it's not
  // an object"));
}
...
TEST(json_results_parser_tests, test_missing_hessian_label_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.hessian("response_fn_1"), JRPE);
  // msg_matches("'hessians' object in JSON results object does not contain
  // 'response_fn_1'"));
}
...
TEST(json_results_parser_tests, test_hessians_not_array_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.hessian("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, Hessian for 'response_fn_1' is not an
  // array"));
}
...
TEST(json_results_parser_tests, test_hessian_row_not_array_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.hessian("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, Hessian for 'response_fn_1' contains a
...
TEST(json_results_parser_tests, test_hessian_non_square_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.hessian("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, Hessian for 'response_fn_1' is not
  // square"));
}
...
TEST(json_results_parser_tests, test_hessian_non_numeric_throws) {
  ...
  JRP test(j);
  EXPECT_THROW(test.hessian("response_fn_1"), JRPE);
  // msg_matches("In JSON results object, Hessian for 'response_fn_1' contains
  // an element that could not be converted to a number"));
}
