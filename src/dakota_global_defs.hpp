...
REGISTER_DAKOTA_ENUM( TABULAR_IFACE_ID,         TABULAR_IFACE_ID       )
REGISTER_DAKOTA_ENUM( TABULAR_EXPER_ANNOT,      TABULAR_EXPER_ANNOT       )
REGISTER_DAKOTA_ENUM( TABULAR_ANNOTATED,        TABULAR_ANNOTATED       )
