...
class PecosApproximation : public Approximation {
 public:
  ...
  const Pecos::RealVector& variance_gradient(
      const Pecos::RealVector& x, const Pecos::SizetArray& dvv) override;
 ...
 protected:
  ...
  void coefficient_labels(
      std::vector<std::string>& coeff_labels) const override;
...
inline const Pecos::RealVector& PecosApproximation::total_sobol_indices()
    const {
...
inline const Pecos::RealVector& PecosApproximation::dimension_decay_rates()
    const {
  return std::static_pointer_cast<Pecos::OrthogPolyApproximation>(polyApproxRep)
...
inline Real PecosApproximation::mean() { return polyApproxRep->mean(); }
...
inline const Pecos::RealVector& PecosApproximation::mean_gradient(
    const Pecos::RealVector& x, const Pecos::SizetArray& dvv) {
  return polyApproxRep->mean_gradient(x, dvv);
}

inline Real PecosApproximation::variance() { return polyApproxRep->variance(); }
...
inline Real PecosApproximation::covariance(const Pecos::RealVector& x,
                                           Approximation& approx_2) {
  std::shared_ptr<PecosApproximation> pa_2 =
      std::static_pointer_cast<PecosApproximation>(approx_2.approx_rep());
...
inline Real PecosApproximation::combined_covariance(const Pecos::RealVector& x,
                                                    Approximation& approx_2) {
  std::shared_ptr<PecosApproximation> pa_2 =
      std::static_pointer_cast<PecosApproximation>(approx_2.approx_rep());
...
inline Real PecosApproximation::beta(const RealVector& x, bool cdf_flag,
                                     Real z_bar) {
...
inline Real PecosApproximation::combined_beta(const RealVector& x,
...
inline Real PecosApproximation::delta_covariance(const Pecos::RealVector& x,
                                                 Approximation& approx_2) {
  std::shared_ptr<PecosApproximation> pa_2 =
      std::static_pointer_cast<PecosApproximation>(approx_2.approx_rep());
...
inline Real PecosApproximation::delta_combined_covariance(
    Approximation& approx_2) {
  std::shared_ptr<PecosApproximation> pa_2 =
      std::static_pointer_cast<PecosApproximation>(approx_2.approx_rep());
...
inline Real PecosApproximation::delta_combined_covariance(
    const Pecos::RealVector& x, Approximation& approx_2) {
  std::shared_ptr<PecosApproximation> pa_2 =
      std::static_pointer_cast<PecosApproximation>(approx_2.approx_rep());
...
inline Real PecosApproximation::delta_beta(const RealVector& x, bool cdf_flag,
                                           Real z_bar) {
...
inline Real PecosApproximation::delta_combined_beta(const RealVector& x,
                                                    bool cdf_flag, Real z_bar) {
...
inline Real PecosApproximation::delta_z(const RealVector& x, bool cdf_flag,
                                        Real beta_bar) {
...
inline Real PecosApproximation::delta_combined_z(const RealVector& x,
                                                 bool cdf_flag, Real beta_bar) {
...
inline const RealVector& PecosApproximation::numerical_integration_moments()
    const {
...
inline void PecosApproximation::build_linear_system(
    RealMatrix& A, const UShort2DArray& multi_index) {
  std::static_pointer_cast<Pecos::RegressOrthogPolyApproximation>(polyApproxRep)
      ->build_linear_system(A, multi_index);
}

inline void PecosApproximation::augment_linear_system(
    const RealVectorArray& samples, RealMatrix& A,
    const UShort2DArray& multi_index) {
  std::static_pointer_cast<Pecos::RegressOrthogPolyApproximation>(polyApproxRep)
      ->augment_linear_system(samples, A, multi_index);
}

inline Pecos::BasisApproximation&
PecosApproximation::pecos_basis_approximation() {
  return pecosBasisApprox;
}
...
// ignore discrete variables for now
inline const Pecos::RealVector& PecosApproximation::gradient(
...
// ignore discrete variables for now
inline const Pecos::RealSymMatrix& PecosApproximation::hessian(
    const Variables& vars) {
...
inline void PecosApproximation::print_coefficients(std::ostream& s,
                                                   bool normalized) {
  pecosBasisApprox.print_coefficients(s, normalized);
}

inline RealVector PecosApproximation::approximation_coefficients(
    bool normalized) const {
  return pecosBasisApprox.approximation_coefficients(normalized);
}

inline void PecosApproximation::approximation_coefficients(
    const RealVector& approx_coeffs, bool normalized) {
  pecosBasisApprox.approximation_coefficients(approx_coeffs, normalized);
}

inline void PecosApproximation::coefficient_labels(
