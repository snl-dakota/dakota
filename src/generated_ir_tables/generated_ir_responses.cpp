...
const std::unordered_map<std::string, KeyContract>& contracts() {
  static const auto kContracts = []() {
    ...
    m.emplace("scalar_data_format", KeyContract{IrValueType::UnsignedShort, DefaultSource::Schema, IRValue{static_cast<unsigned short>(TABULAR_EXPER_ANNOT)}});
...
const std::unordered_map<std::string, std::vector<WriteOp>>& instructions() {
  static const auto kInstructions = []() {
    ...
    m.emplace("response_type/calibration_terms/data_specification/calibration_data/scalar_data_file/format/annotated", std::vector<WriteOp>{
      WriteOp{OpKind::PresenceEnum, "scalar_data_format", OpLiteral{IrValueType::UnsignedShort, IRValue{static_cast<unsigned short>(TABULAR_EXPER_ANNOT)}}},
    });
    m.emplace("response_type/calibration_terms/data_specification/calibration_data/scalar_data_file/format/custom_annotated", std::vector<WriteOp>{
      WriteOp{OpKind::PresenceEnum, "scalar_data_format", OpLiteral{IrValueType::UnsignedShort, IRValue{static_cast<unsigned short>(TABULAR_NONE)}}},
    });
    m.emplace("response_type/calibration_terms/data_specification/calibration_data/scalar_data_file/format/custom_annotated/exp_id", std::vector<WriteOp>{
      WriteOp{OpKind::AugmentEnum, "scalar_data_format", OpLiteral{IrValueType::UnsignedShort, IRValue{static_cast<unsigned short>(TABULAR_EVAL_ID)}}},
    });
    m.emplace("response_type/calibration_terms/data_specification/calibration_data/scalar_data_file/format/custom_annotated/header", std::vector<WriteOp>{
      WriteOp{OpKind::AugmentEnum, "scalar_data_format", OpLiteral{IrValueType::UnsignedShort, IRValue{static_cast<unsigned short>(TABULAR_HEADER)}}},
    });
