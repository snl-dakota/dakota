...
ScalingOptions::ScalingOptions(const ProblemDescDB& pdb,
  ...
  cvScaleTypes =
      scale_str2enum(pdb.get_sa("variables.continuous_design.scale_types"));
  nlnIneqScaleTypes =
      scale_str2enum(pdb.get_sa("responses.nonlinear_inequality_scale_types"));
  nlnEqScaleTypes =
      scale_str2enum(pdb.get_sa("responses.nonlinear_equality_scale_types"));
  linIneqScaleTypes =
      scale_str2enum(pdb.get_sa("variables.linear_inequality_scale_types"));
  linEqScaleTypes =
      scale_str2enum(pdb.get_sa("variables.linear_equality_scale_types"));
  ...
  UShortArray pri_st =
      scale_str2enum(pdb.get_sa("responses.primary_response_fn_scale_types"));
  ...
  expand_for_fields_stl(srd, pri_st, "primary_scale_types", false,
                        priScaleTypes);
