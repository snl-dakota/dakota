...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_base)
{
  /// Dakota input string:
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_bound_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_lin_eq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_nln_eq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_nln_lin_eq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_1_lin_ineq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_2_lin_ineq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_nln_ineq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
    "   optpp_q_newton"
    "     convergence_tolerance = 1.e-9"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_nln_lin_ineq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
...
TEUCHOS_UNIT_TEST(opt_optpp,text_book_nln_lin_eq_ineq_const)
{
  /// Dakota input string:
  static const char text_book_input[] =
    " method,"
