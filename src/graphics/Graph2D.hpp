...
class Graph2D {
 ...
 private:
  ...
  // bool hWheelChange, vWheelChange; // indicates wheel change since last
  // redraw
};
...
inline void Graph2D::set_top_level(Widget tl) { topLevel = tl; }

inline void Graph2D::set_id(int id) { graphId = id; }
