...
const char* Graphics2D::fallbackResources[] = {
    "Graphics2D*borderWidth: 0",
    "Graphics2D*background: gray50",
    "Graphics2D*foreground: white",
    "Graphics2D*tester.plotback.borderWidth: 0",
...
Graphics2D::Graphics2D() : num2dPlots(0), my2dPlots(NULL) {
  ...
  mainWindow =
      XtVaCreateManagedWidget("main_w", xmMainWindowWidgetClass, topLevel,
...
std:
  string res_name = XtNshrinkToFit;
