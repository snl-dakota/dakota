...
void EffGlobalMinimizer::minimize_surrogates_on_model() {
    ...
    unsigned short eifConvergenceCntr = 0;
    unsigned short distConvergenceCntr = 0;
    unsigned short eifConvergenceLimit = 2;
    unsigned short distConvergenceLimit = 1;
    unsigned short globalIterCount = 0;
...
void EffGlobalMinimizer::batch_synchronous_ego() {
    ...
    distConvergenceLimit = BatchSizeAcquisition; // set convergence limit for parallel EGO
