...
static KeyWord
	...
	kw_87[3] = {
		{"expansion_order_sequence",13,5,1,1,kw_83,0.,0.,0,N_mdm(usharray,expansionOrder)},
	...
	kw_105[3] = {
		{"expansion_order_sequence",13,5,1,1,kw_101,0.,0.,0,N_mdm(usharray,expansionOrder)},
	...
	kw_282[6] = {
		{0,0,2,0,0,kw_265},
		{"collocation_points_sequence",13,0,1,1,0,0.,0.,0,N_mdm(szarray,collocationPoints)},
		{"cross_validation",8,1,2,0,kw_281,0.,0.,0,N_mdm(true,crossValidation)},
	...
	kw_290[31] = {
		...
		{"least_interpolation",0,5,8,1,kw_282,0.,0.,4,N_mdm(type,regressionType_ORTHOG_LEAST_INTERPOLATION)},
		...
		{"oli",0,5,8,1,kw_282,0.,0.,1,N_mdm(type,regressionType_ORTHOG_LEAST_INTERPOLATION)},
		{"orthogonal_least_interpolation",8,5,8,1,kw_282,0.,0.,0,N_mdm(type,regressionType_ORTHOG_LEAST_INTERPOLATION)},
