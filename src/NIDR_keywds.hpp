...
static KeyWord
	...
	kw_301[19] = {
		{"calibration_data_file",11,6,4,0,kw_297,0.,0.,0,N_rem(str,expDataFileName)},
		...
		{"field_calibration_terms",0x29,4,8,0,kw_298,0.,0.,0,N_rem(sizet,numFieldLeastSqTerms)},
		{"least_squares_data_file",3,6,4,0,kw_297,0.,0.,-5,N_rem(str,expDataFileName)},
		...
		{"num_field_calibration_terms",0x21,4,8,0,kw_298,0.,0.,-7,N_rem(sizet,numFieldLeastSqTerms)},
		{"num_nonlinear_equality_constraints",0x21,6,6,0,kw_299,0.,0.,-3,N_rem(sizet,numNonlinearEqConstraints)},
		{"num_nonlinear_inequality_constraints",0x21,8,5,0,kw_300,0.,0.,-3,N_rem(sizet,numNonlinearIneqConstraints)},
	...
	kw_318[19] = {
		...
		{"calibration_terms",0x29,19,3,1,kw_301,0.,0.,0,N_rem(sizet,numLeastSqTerms)},
		{"descriptors",15,0,2,0,0,0.,0.,0,N_rem(strL,responseLabels)},
		{"id_responses",11,0,1,0,0,0.,0.,0,N_rem(str,idResponses)},
		{"least_squares_terms",0x21,19,3,1,kw_301,0.,0.,-3,N_rem(sizet,numLeastSqTerms)},
		...
		{"num_least_squares_terms",0x21,19,3,1,kw_301,0.,0.,-8,N_rem(sizet,numLeastSqTerms)},
