...
exception is \texttt{mesh\_adaptive\_search}.  If it is possible to
define a subjective relationship between the different values a given
...
\texttt{neighbor\_order}.
%Branch and bound techniques are discussed in
%Section~\ref{adv_meth:minlp} and nongradient-based methods are further
