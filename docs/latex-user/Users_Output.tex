...
surrogate models support export to text and binary archives for later
reuse in other contexts, such as evaluation from C or Python, or with
the {\tt surfpack} executable or library API. Select Surfpack models
can export to a human-readable and self-documenting algebraic form,
suitable for reuse in user-developed tools. The
