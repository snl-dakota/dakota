...
In addition to these two-dimensional iteration history plots,
...
then the solution is to locate the font files that came with your
...
\href{http://www.cs.sandia.gov/DAKOTA/faq.html#S2}{the support FAQ}.
