...
while the latter handles nonlinear constraints.  \emph{One drawback of
  ...
  look through the Dakota output to confirm what the best function
  value and corresponding parameter values are.  This behavior will
  not be changed, as maintaining third-party source code (such as
  COBYLA) is outside of the Dakota project scope.}
