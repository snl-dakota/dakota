...
using only values of the gradient at current and p
revious iterates.
...
scalable performance for large-scale problems. Note that ROL converts 
inequality constraints into equality constraints with bounded slack 
variables.
