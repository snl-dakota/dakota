...
Certain methods support concurrency in multiple iterator
...
The relevant excerpts from the Dakota output for a peer
...
The peer partition and dynamic scheduling algorithm are
