...
\subsection{Optimization Methods}\label{additional:textbook:methods}
...
in Figure~\ref{additional:rosenbrock_prob}. This example problem
...
file shown in Figure~\ref{additional:rosenbrock_grad} in several key
...
\subsubsection {Least Squares Optimization}\label{additional:rosenbrock:methods:lsq}
...
\subsection{Polynomial Chaos}\label{tutorial:example:uncert_quant:poly_chaos}
...
\subsection{Reliability Methods - via the Mean Value Method}\label{tutorial:example:uncert_quant:reliability}
...
\subsection{Multiobjective Optimization}\label{tutorial:example:optimization:multiobjective}
...
Figure~\ref{additional:moga} shows an example input file that
...
of multi-objective problems~\cite{Coe02}. In this example, the three best 
