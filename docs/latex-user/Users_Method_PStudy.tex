...
are recommended for simple studies with defined, repetative structure.
...
\begin{small}
\begin{verbatim}
    dakota rosen_ps_vector.in > vector.out
\end{verbatim}
\end{small}
...
provided in the \texttt{Dakota/examples/users} directory.
