...
DAKOTA 5.0 has new facilities that may simplify the creation pf
simulator scripts.
...
wake up in a temporary directory, with \$PATH adjusted (if necessary)
...
into the work directory.  Linking is good if files are large, but if they
are to be modified by the simulator, it may be better to have
