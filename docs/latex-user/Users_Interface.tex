...
\begin{figure}
  ...
  \begin{bigbox}
    \begin{small}
      \verbatimtabinput[8]{../../test/examples-users/dakota_rosenbrock.in}
    \end{small}
  \end{bigbox}
...
\begin{figure}
  ...
  \begin{bigbox}
    \begin{small}
      \verbatimtabinput[8]{../../test/examples-users/simulator_script}
    \end{small}
  \end{bigbox}
...
\begin{figure}
  ...
  \begin{bigbox}
    \begin{small}
      \verbatimtabinput[8]{../../test/examples-users/ros.template}
    \end{small}
  \end{bigbox}
