...
quantification (for second-order probability), uncertainty
...
\subsection{Second-order probability} \label{models:ex:sop}

Second-order probability approaches employ nested models to embed one
...
distributions.  These realizations define values for distribution
...
distributions and the generation of statistics on statistics.  These
approaches can be considered to be a special case of imprecise
probability theory.
...
\begin{figure}
  ...
  \begin{bigbox}
    ...
    \end{tiny}
  \end{bigbox}
  \caption{DAKOTA input file for the second-order probability example.}
