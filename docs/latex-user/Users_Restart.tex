...
\textbf{Controlling tabular format:} The command-line option
\texttt{--custom\_annotated} gives control of headers in the resulting
tabular file.  It supports options:
\begin{itemize}
