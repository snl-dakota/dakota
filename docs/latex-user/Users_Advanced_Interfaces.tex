...
As a simple example (from \texttt{dakota/share/dakota/test/dakota\_ampl*}), consider
...
from \texttt{dakota/share/dakota/test/dakota\_ampl\_fma.in}, which demonstrates a
...
{\tt dakota/share/dakota/examples/linked\_interfaces/Matlab}.
...
{\tt dakota/share/dakota/examples/linked\_interfaces/Python}. The Python direct driver is
...
\texttt{dakota/share/dakota/examples/script\_interfaces/Scilab} which demonstrates
...
in \\ {\tt dakota/share/dakota/examples/linked\_interfaces/Scilab/}. This directory also
contains examples for the Rosenbrock and PID problems.

These examples are similar to those in {\tt dakota/share/dakota/examples/script\_interfaces}, with
...
\texttt{dakota/share/dakota/examples/compiled\_interfaces/Matlab}, whose README is likely
instructive. An example of a Scilab compiled interface is included in \\
\texttt{dakota/share/dakota/examples/compiled\_interfaces/Scilab/Rosenbrock}.
