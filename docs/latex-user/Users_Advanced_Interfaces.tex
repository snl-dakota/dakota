...
This chapter will describe algebraic interface mappings based on
AMPL in Section~\ref{advint:algebraic}, followed by discussion 
of development and use of direct interfaces in 
Sections~\ref{advint:direct}--\ref{advint:scilab}.
