...
\path{share/dakota/examples/users/MATLAB/linked/}.
...
\path{share/dakota/examples/official/drivers/Python/linked/}. The Python direct driver is
...
\path{share/dakota/examples/users/Scilab/script/} which demonstrates
...
in \path{share/dakota/examples/users/Scilab/linked/}. This directory also
...
\path{share/dakota/examples/users/MATLAB/compiled/}, whose README is likely
instructive. An example of a Scilab compiled interface is included in \\
\path{share/dakota/examples/users/Scilab/compiled/Rosenbrock/}.
