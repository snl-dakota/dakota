...
see \texttt{dakota/share/dakota/examples/users/cantilever\_uq\_sop\_rel.in} }
...
In \texttt{dakota/share/dakota/test}, test input files such as
...
\texttt{dakota/share/dakota/test/dakota\_uq\_cantilever\_sop\_rel.in}). The process of
...
In \texttt{dakota/share/dakota/test}, additional test input files such as
...
uncertainties can be seen in \texttt{dakota/share/dakota/test} in the input file
...
see \texttt{dakota/share/dakota/examples/users/textbook\_opt\_ouu1.in} }
...
Other nested OUU examples in the \texttt{dakota/share/dakota/test} directory
...
SBOUU examples in the \texttt{dakota/share/dakota/test} directory include
...
TR-SBOUU examples in the \texttt{dakota/share/dakota/test} directory include
...
A number of bi-level RBDO examples are provided in \texttt{dakota/share/dakota/test}.
...
Sequential RBDO examples are also provided in \texttt{dakota/share/dakota/test}. 
...
In \texttt{dakota/share/dakota/test}, the \texttt{dakota\_pcbdo\_cantilever.in},
...
\texttt{textbook\_uq\_surrogate.in} in the \texttt{dakota/share/dakota/examples/users}
directory. 
