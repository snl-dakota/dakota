...
% the modified images.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    path_to_tutorial_examples='../../examples/tutorial/';
    path_to_methods_examples='../../examples/methods/';
        ...
        switch(char(output_files{iout}))
            ...
            case 'rosen_2d_pts.png'
                imagename=plot_rosenbrock_2d_param_study(...
                    path_to_tutorial_examples,ax_rosen_full,...
                    path_to_save_images);
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            ...
            case 'textbook_history.png'
                imagename=plot_textbook_constrained_opt_example(...
                    path_to_tutorial_examples,ax_textbook_full,...
                    path_to_save_images);
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            ...
            case 'rosen_ps_opt_pts2.png'
                imagename=plot_rosenbrock_ps_opt(...
                    path_to_tutorial_examples,ax_rosen_zoom,...
                    path_to_save_images,char(output_files{iout}));
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            ...
            case 'dakota_mogatest1_pareto_front.png'
                imagename=plot_mogatest1(path_to_tutorial_examples,...
                    path_to_save_images);
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            ...
            case 'rosen_sc_pts.png'
                imagename=plot_rosenbrock_sc(...
                    path_to_methods_examples,ax_rosen_sc_lognorm,...
                    path_to_save_images);
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            case 'dakota_mogatest2_pareto_front.png'
                imagename=plot_mogatest2(path_to_methods_examples,...
                    path_to_save_images);
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
            case 'dakota_mogatest3_pareto_set.png'
                imagename=plot_mogatest3(path_to_methods_examples,...
                    path_to_save_images,char(output_files{iout}));
                gimp_command_string=sprintf('%s %s',gimp_command_string,...
                    imagename);
...
function imagename=plot_rosenbrock_2d_param_study(...
    path_to_tutorial_examples,ax,path_to_save_images)

    fid=fopen([path_to_tutorial_examples ...
        'rosenbrock_2d_tabular.dat'],'r');
    if(fid==-1)
        error('Could not find file: "%s"',[path_to_tutorial_examples ...
...
function imagename=plot_textbook_constrained_opt_example(...
    ...
    fid=fopen([path_to_tutorial_examples 'textbook_tabular.dat'],'r');
    if(fid==-1)
        error('Could not find file: "%s"',[path_to_tutorial_examples ...
...
function imagename=plot_rosenbrock_ps_opt(path_to_tutorial_examples,...
...
function imagename=plot_rosenbrock_ea_opt(path_to_tutorial_examples,...
    ax,path_to_save_images,fname)
...
function imagename=plot_mogatest1(path_to_tutorial_examples,...
    path_to_save_images)
    ...
    fid=fopen([path_to_tutorial_examples 'mogatest1_finaldata1.dat'],'r');
    if(fid==-1)
        error('Could not find file: "%s"',[path_to_tutorial_examples ...
...
function imagename=plot_rosenbrock_sc(path_to_methods_examples,ax,...
    path_to_save_images)

    fid=fopen([path_to_methods_examples ...
        'nond_stoch_collocation_tabular.dat'],'r');
    if(fid==-1)
        error('Could not find file: "%s"',[path_to_methods_examples ...
...
function imagename=plot_mogatest2(path_to_methods_examples,...
    path_to_save_images)
    %this function attempts to autoselect good axis bounds for the plot,
    %but parameters in the selection logic (i.e. the spacing of tick marks)
    %assume that the general range of the output does not change MUCH from
...
function imagename=plot_mogatest3(path_to_methods_examples,...
    path_to_save_images,fname)
    %this function attempts to autoselect good axis bounds for the plot,
    %but parameters in the selection logic (i.e. the spacing of tick marks)
    %assume that the general range of the output does not change MUCH from
