...
input parameters are descrbied by a ``prior'' distribution.  The priors
...
An example using the mean value method is included in Section~\ref{additional:textbook:examples:reliability}.
...
Section~\ref{additional:rosenbrock:examples:pce}.  The example
...
Section~\ref{additional:rosenbrock:examples:pce} because of 
...
in Section~\ref{tutorial:example:uncert_quant:interval}.
