...
true response functions.  Skewness and kurtosis are additionally 
reported from direct numerical integration of the response function.
...
differences may exist prior to numerical convergence.  In DAKOTA,
we employ the former approach; i.e., the right-most expressions in
Eqs.~\ref{eq:mean_sc}--\ref{eq:covar_sc} are employed for all tensor
and sparse cases irregardless of nesting.  Subsequent sensitivity
derivations are also based on this choice.
