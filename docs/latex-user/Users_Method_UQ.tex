...
\texttt{probability\_level}, a, and \texttt{confidence\_level}, b, the
Wilks calculation determines the minimum number of samples required
such that there is (b*100)\% confidence that at least (a*100)\% of
the uncertainties in the model output are below the tolerance limit.
