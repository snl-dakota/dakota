...
https://bitbucket.org/mituq/muq2/src/master/ for additional documentation. 
The MUQ implementation in Dakota currently has two types of MCMC 
approaches:  Metropolis-Hastings and Adaptive Metropolis. 
The MUQ implementation in Dakota is a preliminary implementation which we hope to grow 
in future releases of Dakota, to leverage components in MUQ to 
support Hamiltonian Monte Carlo and Langevin-based methods. 
Note that the MUQ method is an experimental method currently 
and MUQ must be enabled when compiling Dakota:  it is not available as a
default method.
