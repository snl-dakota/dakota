...
\left[ - \frac{\left(d_i-\mathcal{M}({\theta})\right)^2}{2{\sigma_d}^2} \right]
...
where $\boldsymbol{r}$ is the vector of residuals between the data points and the model, $\mathcal{M}(\theta)-d_i$.  
