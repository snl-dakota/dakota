...
provided in {\tt dakota/share/dakota/examples/users} starts with a
...
see \texttt{dakota/share/dakota/examples/users/textbook\_hybrid\_strat.in} }
...
see \texttt{dakota/share/dakota/examples/users/qsf\_multistart\_strat.in} }
...
see \texttt{dakota/share/dakota/examples/users/textbook\_pareto\_strat.in} }
...
%\texttt{dakota/share/dakota/test} directory. Note the specification for the
...
\begin{figure}
  ...
  \caption{Dakota input file for the surrogate-based local optimization
    example --
see \texttt{dakota/share/dakota/examples/users/rosen\_opt\_sbo.in} }
...
local optima, look in \texttt{dakota/share/dakota/test} for the file
...
\texttt{dakota/share/dakota/test} to demonstrate this SBO approach. This test
...
see \texttt{dakota/share/dakota/examples/users/mogatest1\_opt\_sbo.in} }
  \label{sbm:sbgm_moga}
\end{figure}
