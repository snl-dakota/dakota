...
local optima, look in \texttt{Dakota/test/dakota\_sbo\_sine\_fcn} for the file
...
\texttt{Dakota/test/dakota\_sbo\_hierarchical} to demonstrate this SBO approach. This test
