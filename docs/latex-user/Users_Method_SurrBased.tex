...
is named \texttt{rosen\_opt\_sbo.in} in the \texttt{Dakota/test}
...
\begin{figure}
  \begin{bigbox}
    \begin{tiny}
      \verbatimtabinput[8]{rosen\_opt\_sbo.in}
    \end{tiny}
  \end{bigbox}
...
This input file
is named \texttt{mogatest1\_opt\_sbo.in} in the \texttt{Dakota/test}
...
\texttt{rosen\_opt\_ego.in} file in the 
