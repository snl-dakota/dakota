...
\subsubsubsection {First Steps}
\begin{enumerate}
  \item Make sure DAKOTA runs - see Section~\ref{tutorial:installation:quickstart:binary}
  \item Create a working directory 
  \item Copy \texttt{dakota_textbook.in from the \texttt{Dakota/examples/tutorial/} directory to the working directory
  \item From the working directory, run \texttt{dakota -i dakota_textbook.in -o Dakota_textbook.out > Dakota_textbook.stdout}
\end{enumerate}


\subsubsubsection {What should happen}
