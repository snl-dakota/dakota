...
the interface, and responses. Figure~\ref{tutorial:inputfile_block_layout} shows 
the most common relationships between blocks but others are possible.  
Most Dakota analyses apply strategies that 
