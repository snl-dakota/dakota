...
\end{enumerate}
  ...
  \item Joining mailing lists and getting help: the most up to date
    ...
    your newly installed Dakota packages includes many useful 
    files, such as
    \texttt{Dakota/INSTALL} or  platform/operating
    system-specific guidance  in {\tt
...
#  \item Make sure Dakota runs - see Section~\ref{tutorial:installation:quickstart:binary}
 \item Make sure Dakota runs - type dakota --version
...
\textt{dakota\_tabular.dat} was changed in the input file to
