...
Table~\ref{tutorial:examples:table}. This table provides a  quick
overview of the method category (e.g. parameter study, 
uncertainty quantification, optimization), specific method 
where applicable, the name of the input file, and a hyperlink. 
Clicking on the hyperlink will take you to the actual input file 
and the associated discussion.  All of these input files 
...
parameter study & moat (Morris) & morris\_ps\_moat.in & ~\ref{FIG:moat:out_preamble} \\
...
uncertainty quantification & sampling on a surrogate model & textbook\_uq\_surrogate.in & ~\ref{adv_models:sbuq} \\
