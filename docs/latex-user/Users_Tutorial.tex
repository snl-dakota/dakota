...
Table~\ref{tutorial:examples:table}. 
...
parameter study & vector parameter study & in PS chapter &  \\
uncertainty quantification & LHS sampling & in tutorial chapter & \\
uncertainty quantification & LHS sampling & in UQ chapter &    \\
uncertainty quantification & Polynomial Chaos Expansion & in UQ chapter & \\
uncertainty quantification & Stochastic Collocation & in UQ chapter &  \\
uncertainty quantification & Stochastic Collocation & in UQ chapter &  \\
uncertainty quantification & Stochastic Collocation & in UQ chapter &  \\
uncertainty quantification & Reliability Mean Value & in UQ chapter &  \\
uncertainty quantification & Reliability FORM & in UQ chapter &  \\
optimization & gradient-based & rosen\_grad\_opt.in in this chapter &  \\
optimization & evolutionary algorithm & opt chapter &   \\
optimization & pattern search  & in opt chapter  &\\
etc & &  & \\
\hline
\end{tabular}
\end{table}
