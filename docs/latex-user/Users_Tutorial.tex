...
contains information on every function evaluation (figure
...
1 show that variable $x1= -2.0$ and $x2=-2.0$, the direct rosenbrock
function is being evaluated and there is one response 3.609e+03.
\end{quote}
