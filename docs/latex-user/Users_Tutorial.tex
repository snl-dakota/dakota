...
\begin{enumerate}
  ...
  \item Install Dakota. \\
    ...
    \texttt{dakota\_binary/share/dakota/INSTALL} (or
    \texttt{dakota\_source/INSTALL}). Further platform/operating
    system-specific guidance can be found in \\
    {\tt dakota\_binary/share/dakota/examples/platforms} \\
    ({\tt dakota\_source/examples/platforms}).
...
\begin{enumerate}
  ...
  \item Copy \texttt{rosen\_multidim.in} from the \texttt{dakota/share/dakota/examples/users/}
...
specification of \texttt{tabular\_data} and \\
\texttt{tabular\_data\_file}. This summarizes 
...
losing all progress.
\end{enumerate}
When running on Unix operating systems with Dakota's legacy X
Windows-based graphics enabled, some plots are created as well, due to
the specification of \texttt{graphics}. These can be helpful when
processing the data or diagnosing unexpected results.  If your
particular installation or build of Dakota does not support graphics,
you will instead get a warning to this effect. The Dakota GUI can also
plot the results of studies.
...
\texttt{dakota/share/dakota/examples/users} directory. As for many of the examples,
...
in the \texttt{dakota/share/dakota/examples/users} directory, with \texttt{.sav}
...
are in the \texttt{dakota/share/dakota/examples/users} directory, with \texttt{.sav} 
...
provided in the directory \texttt{dakota/share/dakota/examples/users}.
...
can be found in \\ \texttt{dakota/share/dakota/examples/users}. 
