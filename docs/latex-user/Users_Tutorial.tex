...
\emph{environment} specification should appear. In Figure~
...
between the six keyword blocks. An environment is used to identify
...
Dakota analyses define a single method, whereas more advanced cases are discussed in Chapter~\ref{adv_meth}.
...
See Chapter~\ref{adv_meth} for more information on these
meta-procedures. The \emph{environment} block also contains the
