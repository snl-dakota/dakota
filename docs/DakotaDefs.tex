...
% Version \DakotaVersion{} Manual
\newcommand{\DakotaVersion}{6.0}


% Most recent SAND report numbers and report date based on
% Data should be SAND report date and not reflect updates
\newcommand{\DakotaSANDDate}{May 2014}
\newcommand{\DakotaSANDDev}{SAND2014-xxxx}
\newcommand{\DakotaSANDRef}{SAND2014-xxxx}
\newcommand{\DakotaSANDUsers}{SAND2014-xxxx}
...
Optimization and Uncertainty Quantification Department \vspace*{\authvskip} \\ 
William~J.~Bohnhoff\\
Radiation Transport Department \vspace*{\authvskip} \\
John~P.~Eddy\\
System Readiness and Sustainment Technologies Department \vspace*{\authvskip} \\
Kenneth~T.~Hu\\
Validation and Uncertainty Quantification Department \vspace*{\authvskip} \\
Keith~R.~Dalbey\\
Mission Analysis and Simulation Department \vspace*{\authvskip} \\
Lara~E.~Bauman, Patricia~D.~Hough \\
Quantitative Modeling and Analysis Department \vspace*{\authvskip} \\
