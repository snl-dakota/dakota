...
introductory topics.  Rather, this manual is intended to summarize a set 
of DAKOTA-related research publications in the areas of surrogate-based 
optimization, uncertainty quantification, optimization under uncertainty, 
and parallel computing that provide the foundation for DAKOTA's iterative
