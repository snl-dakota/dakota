...
Finally, one can additionally modify the exponentiation order applied
to $N_t$ in the over-sampling ratio calculation (refer to {\tt
  ratio\_order} in the PCE regression specification details in the
