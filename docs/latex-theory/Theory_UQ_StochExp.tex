...
the polynomial chaos expansion (PCE) and stochastic collocation (SC).
Both approaches capture the functional relationship between a set of
output response metrics and a set of input random variables.

\section{Orthogonal polynomials in the Askey scheme} \label{uq:expansion:askey}
...
\section{Numerically generated orthogonal polynomials} 
