...
over subsequent levels and the telescopic expansion for the expected value $\mathbb{E}\left[Q_{M_L}\right]$. To simplify the notation and for simplicity of exposure from now on 
