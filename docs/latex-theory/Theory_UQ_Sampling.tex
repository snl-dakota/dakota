...
\section{A multilevel-multifidelity MC approach} \label{uq:sampling:mlmf}
...
control variate (refer to Section~\ref{uq:sampling:controlvariate}). A practical scenario is when not only 
...
control variate approach presented in Section~\ref{uq:sampling:controlvariate}, which stems from 
