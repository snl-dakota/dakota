...
The test file \texttt{dakota/share/dakota/test/dakota\_dace.in} computes 49
...
can be seen in \texttt{dakota/share/dakota/examples/parallelism}.
...
catalogued within {\tt dakota/share/dakota/examples/script\_interfaces} and 
\texttt{dakota/share/dakota/examples/parallelism} (in the software
...
dakota/share/dakota/examples/parallelism/Case*} with the Dakota distribution.
