    ...
    KEYWORD model
        ...
        ( surrogate
          ...
          ( global
            ...
            | actual_model_pointer ALIAS truth_model_pointer STRING ]
            [ reuse_points ALIAS reuse_samples
              all
              | region
              | none
          ...
          |
          ( non_hierarchical ALIAS model_ensemble
            truth_model_pointer ALIAS actual_model_pointer STRING
            unordered_model_fidelities ALIAS approximation_models STRINGLIST
            )
          )
        |
        ( nested
