...
- Fault tolerance: ML BLUE now more consistent with other
  multifidelity sampling methods in the presence of simulation
  faults: (a) exclude all data for a given sample from group
...
- Accuracy control: multifidelity methods can now be target an
...
- Multi-batch processing of concurrent jobs is now supported for
  ...
  ensemble managers such as FLUX, admitting greater concurrency in
  multifidelity method executions.
