.. _ngw-node-hdfTraceBarChartSimpleCorrelation:
...
Using Chartreuse, this node creates a bar chart from a :ref:`simple correlation <uq:correlationtypes>` dataset
...
- **plotFileDataOut**: A complete, serialized version of the plot that can be written out to a
  file for later viewing. Use a file node to save your plot to a file.
