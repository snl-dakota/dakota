...
Before beginning this wizard, you will need a file that declares your expected input variables and output responses.  This could be a :ref:`BMF <bmf-main>` file, or it could
be a Dakota study, if you already have an appropriate Dakota study on hand.
...
.. image:: img/NewDakotaStudy_Drivers_Workflow_1.png
   :alt: Get the variables and responses from our BMF file
